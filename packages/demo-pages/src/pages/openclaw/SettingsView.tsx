                          ...
                          {activeProvider.id !== "nexu" && (
                            <>
                              <button
                                ...
                                disabled={isCheckingAllModels(activeProvider.id) || activeProvider.models.length === 0}
                                ...
                                {activeProvider.id !== "nexu" && (
                                  <button
                                    ...
                                    className={cn(
                                      ...
                                      modelCheckState === "success" && "text-[var(--color-success)]",
                                  ...
                                  >
                                    {modelCheckState === "checking" && t("ws.settings.testingModel")}
                                    {modelCheckState === "success" && t("ws.settings.modelAvailable")}
                                    {modelCheckState === "error" && t("ws.settings.modelUnavailable")}
