          ...
          {[
            ...
            return (
              <button
                ...
                className={`px-4 py-1.5 rounded-full text-[12px] font-medium transition-all ${active ? "bg-surface-1 text-text-primary shadow-[var(--shadow-rest)]" : "text-text-muted hover:text-text-secondary"}`}
              >
                {item.label}
              </button>
            );
                      ...
                      return (
                        <div key={task.id}>
                          ...
                          >
                            ...
                            <span
                              className={`text-[11px] shrink-0 ${task.status === "completed" ? "text-[var(--color-success)]" : task.status === "running" ? "text-[var(--color-warning)]" : "text-text-muted"}`}
                            >
