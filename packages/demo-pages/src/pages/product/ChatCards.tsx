    ...
    <ConversationMessage
      ...
      meta={
        <div className="flex flex-wrap items-center gap-2">
          <span className="text-[12px] font-medium text-text-primary">{card.title}</span>
          <Badge
          ...
          {card.path && (
            <span className="flex items-center gap-1 text-[12px] text-text-muted transition-colors group-hover:text-accent">
      ...
      <div className="space-y-2">
        ...
        {card.viralCta && (
          <div className="flex items-center gap-2 border-t border-accent/10 bg-gradient-to-r from-accent/5 to-transparent px-1 py-2">
            ...
            <span className="cursor-pointer text-[12px] text-accent hover:underline">
              {card.viralCta}
            </span>
          </div>
        )}
