...
const FAQS = [
  {
    ...
    a: "Slack, Discord, and Feishu (Lark) today. WhatsApp and Telegram are on the roadmap.",
  },
  {
    q: "Can the bot read all my messages?",
    a: "The bot only monitors channels you explicitly select. You control what it sees, and all data stays private to your workspace.",
  },
  {
    q: "Is it noisy in my channels?",
    a: "By default, the bot is silent — it only posts digests at scheduled times or when you @mention it. No spam, ever.",
  },
  {
    q: "How is this different from ChatGPT?",
    a: "ChatGPT forgets you every conversation. nexu remembers everything, lives in your existing IM, and proactively turns your group chats into actionable content.",
  },
  {
    q: "How do I get access?",
    a: "nexu is currently invite-only. Request early access or get an invite code from an existing user. Every user gets 3 invite codes to share.",
  },
  {
    q: "What does it cost?",
    a: "Free to start with 500 credits/month — all scenarios included, no feature gates. Pro ($29/mo) gives you 5,000 credits. Team ($19/person/mo) adds shared memory across your team's clones.",
  },
];
    ...
    <div className="min-h-full bg-surface-0">
      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-4xl font-bold text-text-primary tracking-tight leading-tight mb-5">
            Your group chats are a gold mine.
            <br />
          ...
          <p className="text-[11px] text-text-muted mt-4">
            Invite-only early access · Free to start · 2 min setup
          </p>
        </div>
      </section>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-14">
            ...
            <p className="text-sm text-text-tertiary mt-3 max-w-lg mx-auto leading-relaxed">
              Every day, your team produces insights, decisions, and brilliant takes — all buried in
              hundreds of messages nobody will ever scroll back to read.
            </p>
          </div>
            ...
            {[
              {
                ...
                stat: "500+",
                label: "messages/day",
                desc: "in an average team channel",
              },
              {
                icon: Brain,
                stat: "93%",
                label: "forgotten",
                desc: "of valuable discussions are never captured",
              },
              {
                icon: TrendingUp,
                stat: "0",
                label: "content produced",
                desc: "from all those conversations",
              },
            ].map((item) => (
              <div
                key={item.label}
          ...
          <div className="grid grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-text-secondary leading-relaxed">
                Every morning, your clone posts a structured summary of yesterday's chats — key
                decisions, progress updates, action items, and risks.
              </p>
              <div className="bg-surface-2 border border-border rounded-lg p-3 text-[12px] text-text-secondary leading-relaxed">
                <div className="font-medium text-text-primary mb-1.5 text-[11px]">
                  📋 Daily Digest · Feb 25
                </div>
                <div className="space-y-1">
                  <div>
                    🔴 <strong>Needs input:</strong> OAuth scope for Sprint 2
                  </div>
                  <div>
                    🟡 <strong>FYI:</strong> Design review → Thursday 2pm
                  </div>
                  <div>
                    🟢 <strong>Done:</strong> CI pipeline fixed by Alex
                  </div>
                </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-text-secondary leading-relaxed">
                Your clone spots brilliant takes in group chat and turns them into beautiful,
                branded cards you can share on social media in one tap.
              </p>
              <div className="bg-surface-1 border border-border rounded-lg p-4 relative">
                ...
                <div className="flex items-center gap-2">
                  <div className="w-6 h-6 rounded-full bg-clone/15 flex items-center justify-center text-[10px]">
                    S
                  </div>
                  <div>
                    <div className="text-[11px] font-medium text-text-primary">
                      {QUOTE_CARD_EXAMPLE.author}
                    </div>
                    <div className="text-[10px] text-text-muted">
                      {QUOTE_CARD_EXAMPLE.role} · {QUOTE_CARD_EXAMPLE.source}
                    </div>
                  </div>
                </div>
                <div className="absolute top-2 right-3 text-[9px] text-text-muted flex items-center gap-1">
                  <span className="w-3.5 h-3.5 rounded bg-accent flex items-center justify-center text-accent-fg text-[7px] font-bold">
                    N
                  </span>
                  nexu
                </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm text-text-secondary leading-relaxed">
                Your clone extracts shareable insights from group discussions and drafts
                ready-to-post content for X, LinkedIn, or your blog.
              </p>
              <div className="bg-surface-2 border border-border rounded-lg p-3 text-[12px] text-text-secondary leading-relaxed">
                <div className="font-medium text-text-primary mb-1.5 text-[11px]">
                  ✨ Draft ready · from #product
                </div>
                <div className="text-text-secondary">
                  We spent 2 weeks debating OAuth vs. magic links. Here's why we chose both — and
                  the framework that made the decision obvious...
                </div>
                <div className="flex gap-2 mt-2">
                  <span className="text-[10px] px-2 py-0.5 rounded bg-surface-3 text-text-muted">
                    Post to X
                  </span>
                  <span className="text-[10px] px-2 py-0.5 rounded bg-surface-3 text-text-muted">
                    Post to LinkedIn
      ...
      <section id="segments" className="py-20 px-6 bg-surface-2">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <h2 className="text-2xl font-bold text-text-primary tracking-tight">
              Built for teams that live in group chats
            </h2>
          </div>
      ...
      <section id="how" className="py-20 px-6">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-14">
            ...
            <h2 className="text-2xl font-bold text-text-primary tracking-tight">
              2 minutes to set up. Works forever.
            </h2>
          </div>
            ...
            {[
              {
                ...
                icon: Hash,
                title: "Add the bot",
                desc: "One-click install from Slack App Directory, Discord, or Feishu.",
              },
              {
                step: "02",
                icon: Eye,
                title: "Pick your channels",
                desc: "Tell the bot which channels to monitor. It stays silent until needed.",
              },
              {
                step: "03",
                icon: FileText,
                title: "Get your first digest",
                desc: "Instantly generates today's digest from existing messages. Value in seconds.",
              },
              {
                step: "04",
                icon: Sparkles,
                title: "Content flows daily",
                desc: "Every day: digest, quote cards, social drafts. Your chat becomes a content engine.",
              },
            ].map((item) => (
      ...
      <section className="py-16 px-6 bg-surface-2">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-sm text-text-tertiary mt-3 max-w-lg mx-auto leading-relaxed">
              Quote cards carry your brand. Digests get forwarded. Social drafts get posted. Your
              team's daily chats become your marketing engine.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 gap-6">
            {[
              {
                icon: Quote,
                title: "Quote cards with brand",
                desc: 'Every card carries your logo and "Made with nexu". When your team shares, you both grow.',
              },
              {
                icon: BarChart3,
                title: "Chat Wrapped reports",
                desc: "Weekly stats your team actually wants to share — like Spotify Wrapped, but for group chats.",
              },
              {
                icon: Globe,
                title: "One-tap publishing",
                desc: '"This take deserves to be seen." The bot detects shareable moments and lets you post in 3 seconds.',
              },
            ].map((item) => (
      ...
      <section id="pricing" className="py-20 px-6">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-center text-sm text-text-secondary mb-10 -mt-4">
            All plans include every scenario. No feature gates — just more credits.
          </p>
          <div className="grid grid-cols-3 gap-6">
            {[
              {
              ...
              },
              {
                ...
                desc: "/person/month",
                features: [
                  "5,000 credits/person/month",
                  "All scenarios included",
                  "Shared team memory",
                  "Cross-clone knowledge sharing",
                  "Team Wrapped reports",
                  "Admin dashboard",
                ],
                cta: "Contact Us",
                primary: false,
              ...
              <div
                key={plan.name}
                className={`rounded-xl p-6 ${plan.primary ? "bg-accent text-accent-fg border-2 border-accent ring-4 ring-accent/10" : "bg-surface-1 border border-border"}`}
              >
                <div
                  className={`text-xs font-medium mb-1 ${plan.primary ? "text-accent-fg/70" : "text-text-muted"}`}
                >
                  {plan.name}
                </div>
                <div className="flex items-baseline gap-1 mb-4">
                  <span className={`text-2xl font-bold ${plan.primary ? "" : "text-text-primary"}`}>
                    {plan.price}
                  </span>
                  <span
                    className={`text-xs ${plan.primary ? "text-accent-fg/70" : "text-text-muted"}`}
                  >
                    {plan.desc}
                  </span>
                </div>
                <div className="space-y-2 mb-6">
                  {plan.features.map((f) => (
                    <div
                      key={f}
                      className={`flex items-center gap-2 text-[12px] ${plan.primary ? "text-accent-fg/90" : "text-text-secondary"}`}
                    >
                      <CheckCircle2
                        size={12}
                        className={plan.primary ? "text-accent-fg/60" : "text-clone"}
                      />{" "}
                      {f}
                    </div>
                  ))}
      ...
      <section className="py-24 px-6">
        <div className="max-w-2xl mx-auto text-center">
          <h2 className="text-2xl font-bold text-text-primary tracking-tight mb-4">
            Your team talked about 47 great ideas today.
            <br />
            <span className="text-clone">How many will you remember tomorrow?</span>
          </h2>
          <p className="text-sm text-text-secondary mb-8">
            Join the early access. Your first digest is free.
          </p>
          <Button size="lg">
            Request Early Access <ArrowRight size={14} />
          </Button>
