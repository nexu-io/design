...
const en: Record<string, string> = {
  ...
  "budget.depleted.title": "Credits depleted",
  "budget.depleted.desc": "Your free credits have been used up. Resets in {n} days.",
  "budget.depleted.desc1": "Your free credits have been used up. Resets tomorrow.",
  "budget.depleted.byok": "Or bring your own API key to keep using nexu.",
  "budget.depleted.cta": "Set up API Key",
  "budget.depleted.earnMore": "Earn more credits",
  ...
  "ws.settings.tab.agents": "Agents",
  "ws.settings.tab.providers": "Providers",
  "ws.settings.tab.harness": "Harness",
  "ws.settings.tab.instruction": "Instruction",
  "ws.settings.instruction.files": "Instruction Files",
  "ws.settings.instruction.openLocal": "Open local folder",
  "ws.settings.instruction.readonly": "Read-only — edit locally to make changes",
  ...
  "ws.agents.namePlaceholder": "e.g. CEO",
  "ws.agents.adapterType": "Adapter type",
  "ws.agents.moreAdapters": "More Agent Adapter Types",
  "ws.agents.recommended": "Recommended",
  "ws.agents.model": "Model",
  "ws.agents.modelDefault": "Default",
  "ws.agents.envCheck": "Adapter environment check",
  "ws.agents.envCheckDesc": "Runs a live probe that asks the adapter CLI to respond with hello.",
  "ws.agents.testNow": "Test now",
  "ws.agents.addAgent": "Add Agent",
  "ws.agents.desc.claudeCode": "Local Claude agent",
  "ws.agents.desc.codex": "Local Codex agent",
  "ws.agents.desc.geminiCli": "Local Gemini agent",
  "ws.agents.desc.opencode": "Local multi-provider agent",
  "ws.agents.desc.pi": "Local Pi agent",
  "ws.agents.desc.cursor": "Local Cursor agent",
  "ws.agents.desc.hermes": "Local multi-provider agent",
  "ws.agents.desc.openclaw": "Configure OpenClaw within the App",
  ...
  "ws.settings.addCustomProvider": "Add custom provider",
  "ws.settings.customProviderBadge": "Custom",
  "ws.settings.customProviderDraft": "New custom provider",
  "ws.settings.customProviderDraftDesc": "Configure compatibility, endpoint URL, and API key.",
  "ws.settings.customProviderCompatibility": "Compatibility",
  "ws.settings.customProviderCompatibilityOpenAI": "OpenAI-compatible",
  "ws.settings.customProviderCompatibilityAnthropic": "Anthropic-compatible",
  "ws.settings.customProviderInstanceId": "Instance id",
  "ws.settings.customProviderDisplayName": "Display name",
  "ws.settings.customProviderBaseUrl": "Base URL",
  "ws.settings.customProviderCreate": "Create provider",
  "ws.settings.customProviderRemove": "Remove draft",
  "ws.settings.customProviderDescOpenAI": "Custom OpenAI-compatible endpoint",
  "ws.settings.customProviderDescAnthropic": "Custom Anthropic-compatible endpoint",
  "ws.settings.customProviderNoModelsTitle": "No models discovered yet",
  "ws.settings.customProviderNoModelsDesc":
    "Create the provider first, then save your API key and refresh the model list.",
  ...
  "ws.settings.testModel": "Test",
  "ws.settings.testingModel": "Testing...",
  "ws.settings.modelAvailable": "Available",
  "ws.settings.modelUnavailable": "Unavailable",
  "ws.settings.testAllModels": "Test all",
  "ws.settings.testingAllModels": "Testing all...",
  ...
  "ws.settings.searchProviders": "Search providers...",
  "ws.settings.addModel": "Add model",
  "ws.settings.addModelTitle": "Add Model",
  "ws.settings.addModelDesc": "Search or enter a model name to add",
  "ws.settings.addModelPlaceholder": "Search models or enter model ID...",
  "ws.settings.addModelConfirm": "Add",
  "ws.settings.removeModel": "Remove",
  "ws.settings.refreshModels": "Refresh model list",
  "ws.settings.noMatchingModels": "No matching models",
  "ws.settings.customModelId": "Custom model ID",
};
...
const zh: Record<string, string> = {
  ...
  "budget.depleted.title": "积分已耗尽",
  "budget.depleted.desc": "免费积分已用完，将在 {n} 天后重置。",
  "budget.depleted.desc1": "免费积分已用完，明天将重置。",
  "budget.depleted.byok": "你也可以配置自己的 API Key 继续使用 nexu。",
  "budget.depleted.cta": "配置 API Key",
  "budget.depleted.earnMore": "赚取更多积分",
  ...
  "ws.settings.tab.agents": "Agents",
  "ws.settings.tab.providers": "服务商",
  "ws.settings.tab.harness": "Harness",
  "ws.settings.tab.instruction": "指令文件",
  "ws.settings.instruction.files": "指令文件",
  "ws.settings.instruction.openLocal": "打开本地文件夹",
  "ws.settings.instruction.readonly": "只读 — 在本地编辑以进行更改",
  ...
  "ws.agents.namePlaceholder": "例如 CEO",
  "ws.agents.adapterType": "适配器类型",
  "ws.agents.moreAdapters": "更多 Agent 适配器类型",
  "ws.agents.recommended": "推荐",
  "ws.agents.model": "模型",
  "ws.agents.modelDefault": "默认",
  "ws.agents.envCheck": "适配器环境检查",
  "ws.agents.envCheckDesc": "运行实时探针，要求适配器 CLI 响应 hello。",
  "ws.agents.testNow": "立即测试",
  "ws.agents.addAgent": "添加 Agent",
  "ws.agents.desc.claudeCode": "本地 Claude agent",
  "ws.agents.desc.codex": "本地 Codex agent",
  "ws.agents.desc.geminiCli": "本地 Gemini agent",
  "ws.agents.desc.opencode": "本地多模型 agent",
  "ws.agents.desc.pi": "本地 Pi agent",
  "ws.agents.desc.cursor": "本地 Cursor agent",
  "ws.agents.desc.hermes": "本地多模型 agent",
  "ws.agents.desc.openclaw": "在应用内配置 OpenClaw",
  ...
  "ws.settings.addCustomProvider": "添加自定义服务商",
  "ws.settings.customProviderBadge": "自定义",
  "ws.settings.customProviderDraft": "新的自定义服务商",
  "ws.settings.customProviderDraftDesc": "配置兼容协议、端点地址和 API Key。",
  "ws.settings.customProviderCompatibility": "兼容协议",
  "ws.settings.customProviderCompatibilityOpenAI": "兼容 OpenAI",
  "ws.settings.customProviderCompatibilityAnthropic": "兼容 Anthropic",
  "ws.settings.customProviderInstanceId": "实例 ID",
  "ws.settings.customProviderDisplayName": "显示名称",
  "ws.settings.customProviderBaseUrl": "Base URL",
  "ws.settings.customProviderCreate": "创建服务商",
  "ws.settings.customProviderRemove": "删除草稿",
  "ws.settings.customProviderDescOpenAI": "自定义 OpenAI 兼容端点",
  "ws.settings.customProviderDescAnthropic": "自定义 Anthropic 兼容端点",
  "ws.settings.customProviderNoModelsTitle": "暂未发现模型",
  "ws.settings.customProviderNoModelsDesc": "先创建服务商，再保存 API Key 并刷新模型列表。",
  ...
  "ws.settings.testModel": "测试",
  "ws.settings.testingModel": "测试中...",
  "ws.settings.modelAvailable": "可用",
  "ws.settings.modelUnavailable": "不可用",
  "ws.settings.testAllModels": "全部测试",
  "ws.settings.testingAllModels": "测试中...",
  ...
  "ws.settings.searchProviders": "搜索服务商...",
  "ws.settings.addModel": "添加模型",
  "ws.settings.addModelTitle": "添加模型",
  "ws.settings.addModelDesc": "搜索或输入模型名称来添加",
  "ws.settings.addModelPlaceholder": "搜索模型或输入模型 ID...",
  "ws.settings.addModelConfirm": "添加",
  "ws.settings.removeModel": "移除",
  "ws.settings.refreshModels": "刷新模型列表",
  "ws.settings.noMatchingModels": "没有匹配的模型",
  "ws.settings.customModelId": "自定义模型 ID",
};
