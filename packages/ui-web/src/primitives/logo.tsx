...
export type PlatformName = "slack" | "feishu" | "discord" | "telegram";
...
export function FeishuIcon(props: LogoProps) {
  return (
    <SvgLogo viewBox="0 0 24 24" {...props}>
      <path
        d="M11.587 2.015c.889-.553 2.028-.709 3.083-.365l5.785 1.884c1.817.592 2.73 2.648 1.998 4.403l-1.42 3.405a4.003 4.003 0 0 1-2.209 2.174l-5.892 2.349c-.99.394-2.117.32-3.038-.238L5.074 12.61c-1.69-.981-2.186-3.175-1.106-4.786l1.968-2.934a4 4 0 0 1 1.298-1.228l4.353-1.647z"
        fill="#00C2FF"
      />
      <path
        d="M12.717 7.285c.644-.315 1.39-.39 2.087-.163l5.083 1.655a2.79 2.79 0 0 1 1.462 4.143l-2.89 4.443a3.998 3.998 0 0 1-1.931 1.5l-4.83 1.713c-1.192.422-2.519.226-3.546-.555l-4.764-3.62c-1.43-1.088-1.487-3.206-.18-4.365l2.781-2.465a4 4 0 0 1 1.242-.744l5.486-1.542z"
        fill="#3370FF"
      />
      <path
        d="M9.003 9.737c.431-.283.988-.348 1.48-.188l4.755 1.55a1.5 1.5 0 0 1 .181 2.77l-2.193 1.041a4 4 0 0 1-3.162.177l-3.487-1.134a1.5 1.5 0 0 1-.417-2.633l2.843-1.583z"
        fill="#fff"
      />
    </SvgLogo>
  );
