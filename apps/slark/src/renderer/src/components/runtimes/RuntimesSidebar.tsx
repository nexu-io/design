  ...
  return (
    <div className="flex flex-col h-full">
      <div className="px-3 pb-2 flex items-center gap-2">
        <span className="text-xs text-muted-foreground">{onlineCount}/{runtimes.length} online</span>
      </div>
        ...
        {showAdd && (
          <div className="absolute top-9 left-3 right-3 z-50 rounded-lg border border-border bg-popover shadow-lg overflow-hidden">
            ...
            {available.length > 0 ? (
              ...
              <p className="px-3 py-3 text-xs text-muted-foreground text-center">All runtime types added</p>
            )}
          </div>
        )}
      </div>
