...
const statusLabels: Record<Runtime['status'], string> = {
  connected: 'Online', disconnected: 'Offline', error: 'Error'
}
...
const runtimeDataMap: Record<string, RuntimeData> = {
  'rt-1': {
    ...
    models: [
      ...
      { model: 'claude-haiku-4-5-20251001',            tokens: '1.8M',   cost: '$0.35',  color: 'bg-slark-runtime' }
    ],
  ...
  'rt-2': {
    ...
    models: [
      ...
      { model: 'anthropic/claude-4.6-opus-20260205',   tokens: '9.9M',   cost: '$0.68', color: 'bg-slark-primary' },
      { model: 'openai/o3',                             tokens: '3.8M',   cost: '$0.22', color: 'bg-slark-agent' },
      { model: 'google/gemini-2.5-flash',               tokens: '1.6M',   cost: '$0.05', color: 'bg-slark-runtime' }
    ],
...
const heatmapLevels = ['bg-secondary', 'bg-slark-online/20', 'bg-slark-online/40', 'bg-slark-online/60', 'bg-slark-online']
        ...
        <div className="max-w-4xl mx-auto px-6 pb-8 space-y-6">
          ...
          <section className="rounded-xl border border-border p-4">
            ...
            {(() => {
              ...
              if (linked.length === 0) {
                return <p className="text-sm text-muted-foreground text-center py-4">No agents using this runtime</p>
              }
              return (
          ...
          <section className="rounded-xl border border-border p-4">
            ...
            <p className="text-sm text-muted-foreground mb-5">
              Estimated cost ({period}): <span className="font-semibold text-foreground">{usage.cost}</span>
            </p>
            ...
            {data.models.length > 0 ? (
              <>
                <div className="flex flex-col items-center mb-5">
                  <DonutChart segments={data.donutSegments} label={data.totalTokens} sublabel="tokens" />
                </div>
