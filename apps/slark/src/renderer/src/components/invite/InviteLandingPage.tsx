  ...
  return (
    <div className="relative flex min-h-screen w-screen items-center justify-center overflow-hidden bg-background">
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, var(--color-nexu-primary, #6366f1) 0%, transparent 70%)",
        }}
      />
      <div
          ...
          <div className="p-8">
            {state === "idle" && (
              <>
                ...
                <div className="mt-7 space-y-2.5">
                  {[t("invite.feature1"), t("invite.feature2"), t("invite.feature3")].map(
                    (line, i) => (
            ...
            {state === "error" && (
              <div className="flex flex-col items-center py-4 text-center">
                ...
                <p className="mt-1.5 text-sm text-muted-foreground">{t("invite.invalidDesc")}</p>
              </div>
            )}
          </div>
