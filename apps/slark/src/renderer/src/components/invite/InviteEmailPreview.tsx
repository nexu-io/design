    ...
    >
      ...
      >
        <div style={{ padding: "28px 32px 20px", borderBottom: "1px solid #f0f0f0" }}>
          <span
            style={{ fontSize: 20, fontWeight: 700, color: "#6d28d9", letterSpacing: "-0.3px" }}
          >
            Nexu
          </span>
        </div>
        ...
        <div style={{ padding: "32px 32px 28px" }}>
          ...
          <p style={{ fontSize: 14, color: "#71717a", lineHeight: 1.6, margin: "0 0 28px" }}>
            Nexu is where teams collaborate with AI agents — write code, review PRs, and ship faster
            together.
          </p>
        ...
        <div
          style={{ padding: "16px 32px", background: "#fafafa", borderTop: "1px solid #f0f0f0" }}
        >
          <p style={{ fontSize: 11, color: "#a1a1aa", margin: 0, lineHeight: 1.5 }}>
            If you didn't expect this invitation, you can safely ignore this email.
            <br />
            Sent by Nexu on behalf of {inviterName}.
          </p>
        </div>
      </div>
    </div>
