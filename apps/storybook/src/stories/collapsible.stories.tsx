    ...
    <div className="w-[560px] rounded-xl border border-border bg-surface-1 p-4">
      <Collapsible defaultOpen>
        <div className="flex items-center justify-between gap-4">
          ...
          <CollapsibleTrigger className="inline-flex shrink-0 items-center rounded-md px-3 py-2 text-xs font-medium text-text-secondary transition-colors hover:bg-surface-2 hover:text-text-primary">
            Details
          </CollapsibleTrigger>
        </div>
        <CollapsibleContent className="mt-3 rounded-lg border border-border bg-surface-2 px-3 py-2.5 text-xs text-text-secondary">
