...
const en: Record<string, string> = {
  ...
  "ws.settings.account.signIn": "Sign in to nexu",
  ...
  "ws.settings.behavior.launchAtLogin": "Launch at login",
  "ws.settings.behavior.launchAtLoginDesc":
    "Start nexu automatically when you sign in to your computer.",
  "ws.settings.behavior.showInDock": "Show in Dock",
  "ws.settings.behavior.showInDockDesc":
    "Keep nexu visible in the Dock while the desktop app is running.",
  ...
  "ws.settings.about.version": "Version",
...
const zh: Record<string, string> = {
  ...
  "ws.settings.account.signIn": "登录 nexu",
  "ws.settings.account.signOut": "退出登录",
  "ws.settings.behavior.title": "应用行为",
  "ws.settings.behavior.subtitle": "选择 nexu 在当前设备上的运行方式。",
  "ws.settings.behavior.launchAtLogin": "开机启动",
  "ws.settings.behavior.launchAtLoginDesc": "在你登录电脑后自动启动 nexu。",
  "ws.settings.behavior.showInDock": "在 Dock 中显示",
  "ws.settings.behavior.showInDockDesc": "桌面端运行时，在 Dock 中保持 nexu 可见。",
