...
const en: Record<string, string> = {
  ...
  'hero.subtitle': 'Multi-model AI agent that lives in Feishu, Slack & Discord. MIT licensed, self-hostable, ready in 1 minute.',
  ...
  'bento.card1.desc': 'Claude Opus 4.6, GPT-5.4, Gemini 3.0 — switch models freely. Bring your own key or use ours.',
  'bento.card2.title': 'MIT open source, self-hostable',
  'bento.card2.desc': 'Full source on GitHub. Deploy on your own infra, keep data under your control. No vendor lock-in, ever.',
  ...
  'feat.1.desc': 'Claude Opus 4.6, GPT-5.4, Gemini 3.0 — use any model, switch anytime. Bring your own API key or use our hosted endpoint.',
  'feat.2.title': 'IM-native agent',
  'feat.2.desc': 'nexu lives where your team already works — Feishu, Slack, Discord. No new app to learn, no context switching.',
  'feat.3.title': 'Open source & self-host',
  'feat.3.desc': 'MIT licensed. Deploy on your own infrastructure, audit every line of code, keep all data on your servers.',
  'feat.4.title': 'Skills marketplace',
  'feat.4.desc': 'Install community-built skills in one click — from competitive analysis to sprint reviews. Or build your own.',
  'feat.5.title': 'Memory that compounds',
  'feat.5.desc': 'nexu remembers your context, preferences, and decisions. The longer you use it, the smarter it gets.',

  // Landing - KPI
  'kpi.heading1': 'Built for',
  'kpi.heading2': 'Real Teams',
  'kpi.1.label': 'Setup time', 'kpi.1.value': '<1 min', 'kpi.1.desc': 'Add nexu to your Slack or Discord workspace and start chatting immediately. No server setup required.',
  'kpi.2.label': 'Models supported', 'kpi.2.value': '10+', 'kpi.2.desc': 'Claude Opus 4.6, GPT-5.4, Gemini 3.0, Llama and more. Switch freely or bring your own API key.',
  'kpi.3.label': 'IM platforms', 'kpi.3.value': '3+', 'kpi.3.desc': 'Feishu, Slack, Discord — native integration. WhatsApp and Telegram coming soon.',
  'kpi.4.label': 'License', 'kpi.4.value': 'MIT', 'kpi.4.desc': 'Fully open source under MIT license. Fork it, self-host it, extend it — no strings attached.',
  'kpi.5.label': 'Community skills', 'kpi.5.value': '100+', 'kpi.5.desc': 'Install pre-built skills for competitive analysis, sprint reviews, content creation, and more.',
  'kpi.6.label': 'Data residency', 'kpi.6.value': '100%', 'kpi.6.desc': 'Self-host on your own infrastructure. Your data never leaves your servers.',

  // Landing - Promise
  'promise.label': 'Why open source',
  'promise.p1': 'We believe AI that works alongside your team should be transparent, auditable, and under your control.',
  'promise.p2': "Most AI tools are black boxes — you send data to someone else's server, hope for the best, and have no idea what happens inside. That's not how we think work tools should be built.",
  'promise.p3': 'nexu is MIT licensed. Every line of code is on GitHub. You can self-host it, fork it, extend it, audit it. Your conversations, your memory, your data — they stay yours.',
  'promise.p4': 'Open source isn\'t just a license. It\'s a promise: the tool that runs your team\'s workflow will never hold your data hostage, never lock you in, never disappear behind a paywall.',

  // Landing - Community
  'community.label': 'Community',
  'community.title': 'Trusted by teams building the future of work',
  'community.card1': 'nexu is fully open source under the MIT license. Inspect every line, self-host on your infrastructure, and extend with community-built skills. Your AI teammate, your rules.',
  'community.card2.label': 'Multi-model',
  'community.card2': 'Switch between Claude Opus 4.6, GPT-5.4, Gemini 3.0, and more — use the best model for each task without changing tools.',
  ...
  'auth.subtitle': 'Connect Feishu, Slack, Discord — automate your team workflow with AI. Open source, secure, ready to go.',
  ...
  'auth.success.desc': 'Your Nexu desktop client is now connected to your cloud account. You can close this tab and return to the app.',
  ...
  'brand.bullet.models': 'Top-tier model access: Claude Opus 4.6, GPT-5.4, MiniMax 2.5, GLM 5.0, Kimi K2.5, and more',
  ...
  'welcome.subtitle': 'Choose how you want to start with nexu. Use the official account path for the full experience, or connect your own API key directly.',
  ...
  'ws.settings.signInDesc': 'Sign in with your nexu account to access unlimited premium models like Claude Opus 4.6, GPT-5.4, and more — no API key needed.',
  ...
  'ws.settings.connectionFailed': 'Connection failed. Check your API key format, or use Test connection to verify.',
...
const zh: Record<string, string> = {
  ...
  'hero.subtitle': '多模型 AI Agent，原生集成飞书、Slack、Discord。MIT 开源协议，可私有化部署，1 分钟上手。',
  ...
  'bento.card1.desc': 'Claude Opus 4.6、GPT-5.4、Gemini 3.0 — 自由切换模型。可用自己的 Key，也可用我们的。',
  ...
  // Landing - Feature accordion
  'feat.1.title': '多模型自由',
  'feat.1.desc': 'Claude Opus 4.6、GPT-5.4、Gemini 3.0 — 任意模型随时切换。可用自己的 API Key，也可用我们的托管端点。',
  'feat.2.title': 'IM 原生 Agent',
  'feat.2.desc': 'nexu 就在你团队日常使用的工具里 — 飞书、Slack、Discord。无需学习新工具，无需切换上下文。',
  ...
  'kpi.heading1': '为真实',
  'kpi.heading2': '团队而生',
  'kpi.1.label': '部署时间', 'kpi.1.value': '<1 分钟', 'kpi.1.desc': '把 nexu 添加到你的 Slack 或 Discord 工作区，立即开始对话。无需服务器配置。',
  'kpi.2.label': '支持模型', 'kpi.2.value': '10+', 'kpi.2.desc': 'Claude Opus 4.6、GPT-5.4、Gemini 3.0、Llama 等。自由切换或使用自己的 API Key。',
  'kpi.3.label': 'IM 平台', 'kpi.3.value': '3+', 'kpi.3.desc': '飞书、Slack、Discord 原生集成。WhatsApp 和 Telegram 即将支持。',
  'kpi.4.label': '开源协议', 'kpi.4.value': 'MIT', 'kpi.4.desc': '完全开源，MIT 协议。Fork、私有化部署、二次开发，没有任何限制。',
  'kpi.5.label': '社区 Skills', 'kpi.5.value': '100+', 'kpi.5.desc': '安装预构建的 Skill：竞品分析、Sprint 回顾、内容创作等。',
  'kpi.6.label': '数据自主', 'kpi.6.value': '100%', 'kpi.6.desc': '私有化部署在你自己的基础设施上。你的数据永远不会离开你的服务器。',

  // Landing - Promise
  'promise.label': '为什么开源',
  'promise.p1': '我们相信，与你团队并肩工作的 AI，应该是透明的、可审计的、由你掌控的。',
  'promise.p2': '大多数 AI 工具都是黑盒 — 你把数据发送到别人的服务器，然后祈祷一切顺利，完全不知道里面发生了什么。我们认为工作工具不应该这样。',
  'promise.p3': 'nexu 采用 MIT 开源协议。每一行代码都在 GitHub 上。你可以私有化部署、Fork、扩展、审计。你的对话、你的记忆、你的数据 — 都属于你。',
  'promise.p4': '开源不只是一个协议。它是一个承诺：运行你团队工作流的工具，永远不会绑架你的数据，永远不会锁定你，永远不会藏在付费墙后面。',

  // Landing - Community
  'community.label': '社区',
  'community.title': '被构建未来工作方式的团队所信赖',
  'community.card1': 'nexu 完全开源，MIT 协议。审查每一行代码，私有化部署在你的基础设施上，用社区构建的 Skill 扩展。你的 AI 队友，你做主。',
  'community.card2.label': '多模型',
  'community.card2': '在 Claude Opus 4.6、GPT-5.4、Gemini 3.0 等模型间自由切换 — 为每个任务使用最合适的模型，无需更换工具。',
  ...
  'brand.bullet.models': '连接了 Claude Opus 4.6、GPT-5.4、MiniMax 2.5、GLM 5.0、Kimi K2.5 等顶级模型',
  'brand.github': '在 GitHub 上 Star nexu',
  'welcome.pageTitle': '欢迎来到 nexu',
  'welcome.mobileLabel': '客户端',
  'welcome.label': '开始使用',
  'welcome.title': '选择你的开始方式',
  'welcome.subtitle': '选择一种方式开始使用 nexu。你可以使用官方账号获得完整体验，或直接连接你自己的 API Key。',
  ...
  'ws.settings.signInDesc': '登录 nexu 账号即可无限使用 Claude Opus 4.6、GPT-5.4 等高级模型，无需 API Key。',
