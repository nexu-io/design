    ...
    <div className="space-y-8">
      ...
      <Step n={1} title="打开技能页面">
        <p className="text-[13px] text-text-tertiary leading-relaxed">
          在 nexu 客户端左侧导航栏点击 <strong className="text-text-primary">Skills</strong>，进入技能中心。
          <strong className="text-text-primary"> Explore</strong> 标签展示所有可安装的公共技能，支持按分类筛选（Office & Collaboration、Files & Knowledge、Creative & Design、Business Analysis、Audio & Video 等）或直接搜索关键词。
        </p>
      ...
      <Step n={2} title="找到并安装技能">
        <p className="text-[13px] text-text-tertiary leading-relaxed">
          浏览或搜索目标技能，点击卡片上的 <strong className="text-text-primary">Install</strong> 按钮。技能支持热加载，安装后无需重启 Agent 即可立即生效。
        </p>
      ...
      <Step n={3} title="确认安装">
        <p className="text-[13px] text-text-tertiary leading-relaxed">
          切换到 <strong className="text-text-primary">Yours</strong> 标签，查看已安装的技能列表，并可通过开关随时启用或禁用单个技能。
        </p>
      ...
      <Callout variant="tip">
        从 <strong>Office & Collaboration</strong> 或 <strong>Files & Knowledge</strong> 分类入手，这些技能覆盖了大多数团队的日常需求。
      </Callout>
