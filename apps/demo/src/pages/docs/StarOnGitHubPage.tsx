import { ArrowUpRight, GitFork, Globe, Heart, Shield, Sparkles, Star, Users } from "lucide-react";
  ...
  return (
    <>
      ...
      <p className="mt-2 text-[14px] text-text-tertiary leading-relaxed max-w-2xl">
        nexu is open-source and community-driven. A GitHub star is the simplest way to support us —
        it takes one click and makes a real difference.
      </p>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-[12px] text-text-tertiary">
                Fix a bug, add a skill, or improve the docs.
              </p>
            </div>
            <ArrowUpRight
              size={14}
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-[12px] text-text-tertiary">
                Share nexu with your team or on social media.
              </p>
            </div>
            <ArrowUpRight
              size={14}
