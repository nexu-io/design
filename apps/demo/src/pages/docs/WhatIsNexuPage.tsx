  ...
  return (
    <>
      ...
      <p className="mt-3 text-[14px] text-text-tertiary leading-relaxed max-w-2xl">
        nexu is an AI teammate that lives in your team chat. It remembers your context, learns your
        style, and ships real work — drafts, research, follow-ups — so you can focus on decisions,
        not execution. Unlike generic AI assistants, nexu gets better the more your team uses it.
      </p>
          ...
          return (
            ...
            >
              ...
              <div>
                ...
                <div className="text-[12px] text-text-tertiary mt-0.5 leading-relaxed">
                  {f.desc}
                </div>
              </div>
            </div>
