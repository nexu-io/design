    ...
    <PageShell>
      ...
      <Section title='Clone Breath — 分身呼吸'>
        <div className='flex items-center gap-8'>
          ...
          <div className='text-center'>
            <div className='w-20 h-20 rounded-full bg-surface-3 mx-auto flex items-center justify-center' style={{ animation: 'clone-breath 1.5s ease-in-out infinite', boxShadow: '0 0 14px 3px rgba(192,138,37,0.35)' }}>
              <span className='text-2xl'>🤔</span>
            </div>
          ...
          <div className='text-center'>
            <div className='w-20 h-20 rounded-full bg-surface-3 mx-auto flex items-center justify-center' style={{ animation: 'clone-breath 4s ease-in-out infinite', boxShadow: '0 0 8px 2px rgba(202,138,4,0.25)' }}>
              <span className='text-2xl'>😅</span>
            </div>
          ...
          <div className='text-center'>
            <div className='w-20 h-20 rounded-full bg-surface-3 mx-auto flex items-center justify-center' style={{ boxShadow: '0 0 20px 4px rgba(202,138,4,0.35)', animation: 'clone-breath 0.8s ease-in-out 3' }}>
              <span className='text-2xl'>🤩</span>
            </div>
      ...
      <Section title='Thinking Dots — 分身思考'>
        <div className='bg-surface-2 border border-border rounded-lg px-5 py-4 inline-flex items-center gap-3'>
          <div className='w-8 h-8 rounded-full bg-surface-3 animate-clone-breath flex items-center justify-center text-sm'>🤔</div>
      ...
      <Section title='Message Enter — 消息入场'>
        <div className='space-y-3 max-w-md'>
          <div className='animate-fade-in-up bg-surface-2 border border-border rounded-lg px-4 py-3' style={{ animationDelay: '0s' }}>
            <div className='text-[13px] text-text-primary'>搞定了，你看看效果 ✅</div>
          </div>
          <div className='animate-fade-in-up bg-surface-2 border border-border rounded-lg px-4 py-3' style={{ animationDelay: '0.3s', opacity: 0 }}>
            <div className='text-[13px] text-text-primary'>方案已经写好了，包含 3 种登录方式的对比。</div>
          </div>
          <div className='animate-fade-in-up bg-surface-2 border border-border rounded-lg px-4 py-3' style={{ animationDelay: '0.6s', opacity: 0 }}>
            <div className='text-[13px] text-text-primary'>推荐方案 A，因为你的用户更看重速度。</div>
          </div>
        </div>
        <div className='text-[11px] text-text-muted mt-3'>8px slideUp + fadeIn, 350ms ease-out, staggered</div>
      </Section>
      ...
      <Section title='Energy Drain — 能量消耗'>
        <div className='max-w-md space-y-4'>
          <div>
            ...
            <div className='w-full h-3 rounded-full overflow-hidden' style={{ background: 'linear-gradient(to right, #16a34a 0%, #16a34a 40%, #ca8a04 60%, #ea580c 80%, #dc2626 100%)' }} />
          ...
          <div>
            ...
            <div className='w-full h-3 bg-surface-4 rounded-full overflow-hidden'>
              <div className='h-full rounded-full bg-danger animate-energy-pulse' style={{ width: '7%' }} />
            </div>
          </div>
        </div>
      </Section>
      ...
      <Section title='Float — 落地页元素'>
        <div className='flex gap-8 items-center'>
          <div className='animate-float'>
            <div className='w-16 h-16 rounded-2xl bg-accent-subtle border border-accent flex items-center justify-center text-2xl'>🧠</div>
          </div>
          <div className='animate-float' style={{ animationDelay: '0.5s' }}>
            <div className='w-16 h-16 rounded-2xl bg-success-subtle border border-success flex items-center justify-center text-2xl'>✅</div>
          </div>
          <div className='animate-float' style={{ animationDelay: '1s' }}>
            <div className='w-16 h-16 rounded-2xl bg-warning-subtle border border-warning flex items-center justify-center text-2xl'>⚡</div>
          </div>
      ...
      <Section title='Timing Functions'>
        <div className='space-y-3 max-w-lg'>
          {[
            ...
            <div key={t.name} className='flex items-center gap-4 bg-surface-2 border border-border rounded-md p-3'>
      ...
      <Section title='Duration Scale'>
        <div className='flex gap-3'>
          {[
            ...
            <div key={d.name} className='bg-surface-2 border border-border rounded-md p-3 text-center flex-1'>
