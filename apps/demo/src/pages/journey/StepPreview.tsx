...
function FeishuMsg({ from, name, avatar, children, time }: {
      ...
      <div className='grid grid-cols-2 gap-5'>
        ...
        <div className='bg-surface-1 border border-border rounded-xl overflow-hidden'>
          <div className='px-4 py-2.5 bg-[#2b5fd9]/5 border-b border-border flex items-center gap-2'>
            ...
            <span className='text-[9px] bg-surface-3 px-1.5 py-0.5 rounded text-text-muted ml-auto'>6 人</span>
          </div>
          <div className='p-3 space-y-2.5 max-h-[360px] overflow-y-auto'>
            ...
            <FeishuMsg from='clone' name='Tom 的分身' time='10:02'>
              ...
              <div className='mt-1.5 text-[9px] text-text-muted'>数据来自本周 12 次对话 + Linear</div>
            </FeishuMsg>
        ...
        <div className='bg-surface-1 border border-border rounded-xl overflow-hidden'>
          <div className='px-4 py-2.5 bg-clone/5 border-b border-border flex items-center gap-2'>
            ...
            <span className='text-[9px] bg-clone/10 text-clone px-1.5 py-0.5 rounded ml-auto'>自动推送</span>
          </div>
          <div className='p-3 space-y-2.5'>
            <div className='flex items-center gap-2 mb-1'>
              <div className='w-6 h-6 rounded-full bg-clone/10 flex items-center justify-center text-[10px]'>😊</div>
        ...
        <div className='bg-surface-1 border border-border rounded-xl overflow-hidden'>
          <div className='px-4 py-2.5 border-b border-border flex items-center gap-2'>
            ...
            <span className='text-[9px] bg-warning-subtle text-warning px-1.5 py-0.5 rounded ml-auto'>Proactive</span>
          </div>
          <div className='p-3 space-y-2.5'>
            <div className='flex items-center gap-2 mb-1'>
              <div className='w-6 h-6 rounded-full bg-clone/10 flex items-center justify-center text-[10px]'>😊</div>
        ...
        <div className='bg-surface-1 border border-border rounded-xl overflow-hidden'>
          <div className='px-4 py-2.5 border-b border-border flex items-center gap-2'>
            ...
            <span className='text-[9px] bg-clone/10 text-clone px-1.5 py-0.5 rounded ml-auto'>Skills</span>
          </div>
          <div className='p-3 space-y-2.5'>
