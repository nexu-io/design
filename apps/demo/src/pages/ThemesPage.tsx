      ...
      <Section title="如何切换主题">
        <div className="bg-surface-2 rounded-lg border border-border p-6">
          <p className="text-sm text-text-secondary mb-4">
            ...
            有两个按钮：「默认」「线上」。点击即可切换当前主题；选择会写入本地存储，刷新后保持。
          </p>
      ...
      <Section title="文档">
        <ul className="space-y-2 text-sm text-text-secondary">
          <li>
            ...
            — 默认主题色板参考；线上版本完整色板见 DESIGN-SYSTEM-ONLINE.md
          </li>
          <li>
            <Link to="/components" className="text-accent hover:underline">
              Components
            </Link>{" "}
            — 使用 token 的组件会随侧栏主题切换而变化
          </li>
          <li>
            <span className="text-text-tertiary">DESIGN-SYSTEM-ONLINE.md</span> —
            线上版本完整规范（色彩、圆角、组件约定）
          </li>
        </ul>
      </Section>
