    ...
    return (
      <div className="max-w-md mx-auto space-y-3">
        <div className="card p-6 text-center">
          <div className="flex justify-center items-center w-12 h-12 rounded-lg mx-auto mb-4" style={{ background: 'rgba(74,21,75,0.10)' }}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="#611f69">
              <path d={SLACK_ICON_PATH} />
            </svg>
          </div>
          <h3 style={{ fontSize: 14, fontWeight: 600, color: 'var(--color-text-primary)', fontFamily: FONT, marginBottom: 4 }}>
            Add nexu to Slack
          </h3>
          ...
          <Button
            ...
            onMouseEnter={(e) => { e.currentTarget.style.background = '#4a154b'; }}
            onMouseLeave={(e) => { e.currentTarget.style.background = '#611f69'; }}
          >
        ...
        >
          <Key size={11} />
          <span>Using your own Slack App? <span className="underline underline-offset-2">Enter token manually</span></span>
        </Button>
      </div>
    );
  }
    ...
    return (
      <div className="max-w-md mx-auto">
        <div className="card p-8 text-center">
          <div className="flex justify-center items-center w-12 h-12 rounded-lg mx-auto mb-5" style={{ background: 'rgba(74,21,75,0.10)' }}>
            <div
          ...
          <p style={{ fontSize: 12, color: 'var(--color-text-muted)', lineHeight: 1.6, fontFamily: FONT }}>
  ...
  if (phase === 'manual') {
    ...
    return (
      <div className="max-w-2xl">
        <div
          className="flex gap-3 items-start p-4 rounded-lg mb-5"
          style={{ background: 'rgba(61,185,206,0.05)', border: '1px solid rgba(61,185,206,0.15)' }}
        >
          <AlertCircle size={16} style={{ color: 'var(--color-brand-primary)', marginTop: 2, flexShrink: 0 }} />
          <div>
            <div style={{ fontSize: 13, fontWeight: 600, color: 'var(--color-text-primary)', fontFamily: FONT }}>Manual setup</div>
            <p style={{ fontSize: 12, color: 'var(--color-text-muted)', marginTop: 2, lineHeight: 1.6, fontFamily: FONT }}>
              Use your own Slack App to customize Bot name and avatar. For teams who want a branded Bot.
              <Button
                variant="link"
          ...
          {manualSteps.map((s, i) => (
            ...
            >
              ...
              <div style={{
                ...
                marginTop: 8,
                fontFamily: FONT,
                color: i === manualStep ? '#611f69' : i < manualStep ? 'var(--color-text-secondary)' : 'rgba(144,149,153,0.5)',
          ...
          <div className="card p-5">
            <div className="flex gap-3 items-start mb-4">
              <div
                ...
                style={{ background: 'rgba(97,31,105,0.10)', fontSize: 12, fontWeight: 700, color: '#611f69', fontFamily: FONT }}
              >
                1
              </div>
              <div>
                <h3 style={{ fontSize: 14, fontWeight: 600, color: 'var(--color-text-primary)', fontFamily: FONT }}>Create Slack App</h3>
                <p style={{ fontSize: 12, color: 'var(--color-text-muted)', marginTop: 4, lineHeight: 1.6, fontFamily: FONT }}>
                ...
                {[
                  ...
                  <div key={i} className="flex gap-2.5 items-start">
                    <div
                      ...
                      style={{ background: 'var(--color-surface-2)', fontSize: 9, fontWeight: 700, color: 'var(--color-text-muted)', fontFamily: FONT }}
                    >
                      {i + 1}
                    </div>
                    <span style={{ fontSize: 12, color: 'var(--color-text-secondary)', lineHeight: 1.6, fontFamily: FONT }}>{item}</span>
                  </div>
                ))}
              </div>
        ...
        {manualStep === 1 && (
          <div className="card p-5">
            <div className="flex gap-3 items-start mb-4">
              ...
              <div>
                <h3 style={{ fontSize: 14, fontWeight: 600, color: 'var(--color-text-primary)', fontFamily: FONT }}>Enter credentials</h3>
                <p style={{ fontSize: 12, color: 'var(--color-text-muted)', marginTop: 4, lineHeight: 1.6, fontFamily: FONT }}>
            ...
            <div className="ml-11 space-y-3">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  />
                  <Lock size={13} className="absolute right-3 top-1/2 -translate-y-1/2 text-text-placeholder" />
                </div>
                <p className="text-[10px] text-text-tertiary mt-1">
        ...
        {manualStep === 2 && (
          <div className="card p-5">
            <div className="flex gap-3 items-start mb-4">
              ...
              <div>
                <h3 style={{ fontSize: 14, fontWeight: 600, color: 'var(--color-text-primary)', fontFamily: FONT }}>Set callback URL</h3>
                <p style={{ fontSize: 12, color: 'var(--color-text-muted)', marginTop: 4, lineHeight: 1.6, fontFamily: FONT }}>
            ...
            <div className="ml-11 space-y-3">
              ...
              >
                <code className="flex-1 break-all" style={{ fontSize: 12, color: 'var(--color-text-secondary)', fontFamily: MONO }}>
        ...
        {manualStep === 3 && (
          <div className="card p-5">
            <div className="flex gap-3 items-start mb-4">
              ...
              <div>
                <h3 style={{ fontSize: 14, fontWeight: 600, color: 'var(--color-text-primary)', fontFamily: FONT }}>Confirm Bot permissions</h3>
                <p style={{ fontSize: 12, color: 'var(--color-text-muted)', marginTop: 4, lineHeight: 1.6, fontFamily: FONT }}>
            ...
            <div className="ml-11 space-y-4">
              <div className="rounded-lg overflow-hidden" style={{ border: '1px solid rgba(0,0,0,0.10)' }}>
                <div className="px-3.5 py-2.5 bg-surface-2 border-b border-border">
                  <span style={{ fontSize: 11, fontWeight: 600, color: 'var(--color-text-secondary)', textTransform: 'uppercase', letterSpacing: '0.05em', fontFamily: FONT }}>
                    Required Scopes
                  </span>
                </div>
                {REQUIRED_SLACK_SCOPES.map((s, i) => (
                  <div
                    ...
                    style={{ borderBottom: i < REQUIRED_SLACK_SCOPES.length - 1 ? '1px solid rgba(0,0,0,0.10)' : 'none' }}
                  >
                    <CheckCircle2 size={12} className="text-success shrink-0" />
                    <code
                      className="px-1.5 py-0.5 rounded"
                      style={{ fontSize: 11, fontFamily: MONO, color: '#611f69', background: 'rgba(97,31,105,0.08)', fontWeight: 500 }}
                    >
                      {s.scope}
                    </code>
                    <span style={{ fontSize: 11, color: 'var(--color-text-muted)', fontFamily: FONT }}>{s.desc}</span>
                  </div>
                ))}
              </div>
              <Button
        ...
        <div className="card flex gap-3 items-center p-4 mt-5">
          <BookOpen size={14} style={{ color: '#611f69', flexShrink: 0 }} />
          <p style={{ fontSize: 11, color: 'var(--color-text-muted)', lineHeight: 1.6, fontFamily: FONT }}>
            Need help? See{' '}
            <a
  ...
  return (
    <div className="max-w-md mx-auto space-y-4">
      <div className="card p-8 text-center">
        ...
        <h3 style={{ fontSize: 22, fontWeight: 600, color: 'var(--color-text-primary)', fontFamily: FONT, marginBottom: 4 }}>
          Slack connected!
        </h3>
        <p style={{ fontSize: 13, color: 'var(--color-text-muted)', marginBottom: 24, lineHeight: 1.6, maxWidth: 320, marginLeft: 'auto', marginRight: 'auto', fontFamily: FONT }}>
        ...
        <div className="space-y-2.5 text-left max-w-[300px] mx-auto mb-6">
          <div style={{ fontSize: 11, fontWeight: 500, color: 'var(--color-text-muted)', textTransform: 'uppercase', letterSpacing: '0.08em', fontFamily: FONT }}>
            Next steps
          </div>
          {[
            ...
            <div key={s.step} className="flex gap-2.5 items-center">
              <div
                ...
                style={{ background: 'rgba(61,185,206,0.10)', fontSize: 10, fontWeight: 600, color: 'var(--color-brand-primary)', fontFamily: FONT }}
              >
                {s.step}
              </div>
              <span style={{ fontSize: 12, color: 'var(--color-text-secondary)', fontFamily: FONT }}>{s.text}</span>
            </div>
          ))}
        </div>

        <div className="p-3 rounded-[12px] text-left bg-surface-2" style={{ border: '1px solid rgba(0,0,0,0.06)' }}>
          <div className="flex gap-2 items-start">
            <Zap size={12} style={{ color: 'var(--color-brand-primary)', marginTop: 2, flexShrink: 0 }} />
            <p style={{ fontSize: 11, color: 'var(--color-text-muted)', lineHeight: 1.6, fontFamily: FONT }}>
              <span className="font-medium" style={{ color: 'var(--color-text-secondary)' }}>Share with teammates:</span> When they sign up for nexu, Slack connects automatically — no re-auth needed.
            </p>
          </div>
        </div>
      </div>
...
export default function ChannelsPage() {
  ...
  return (
    <div
      ...
      ref={(el) => { if (el && !entered) requestAnimationFrame(() => setEntered(true)); }}
    >
      <div className="max-w-4xl mx-auto px-8 py-8">
        ...
        <p className="heading-page-desc mb-6">
          Manage nexu connection to your Slack workspace
        </p>
