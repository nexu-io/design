...
const TRUSTED_LOGOS = ["Raycast", "Vercel", "Supabase", "Udemy", "Framer", "Ramp", "Linear"];
...
const TESTIMONIALS = [
  {
    quote:
      "I used to triage 200+ GitHub issues manually every week. nexu does it in minutes and nothing falls through the cracks. I finally have time for actual engineering work.",
    name: "Sara Patel",
    role: "Engineering Lead, Basalt",
  },
  {
    quote:
      "I was the human router for our team — every question went through me. nexu took over the cross-tool coordination and gave me 10+ hours a week back.",
    name: "Mike Rodriguez",
    role: "Head of Ops, Campfire",
  },
  {
    quote:
      "Our support team’s response times dropped 60%. nexu handles the routine coordination — pulling account info, checking status, drafting responses — so we focus on real problems.",
    name: "Anna Liu",
    role: "VP Support, Daybreak",
  },
  {
    quote:
      "The Slack integration was seamless — added it in under a minute, connected our tools, and it just worked. No config files, no setup headaches. It feels like Slack it was always there.",
    name: "David Torres",
    role: "Founder, Trigger.dev",
  },
  {
    quote:
      "We spent hours every week on status updates — copying from GitHub to Slack to Notion. Now we just ask nexu. The coordination overhead vanished overnight.",
    name: "James Kim",
    role: "CTO, Stackline",
  },
];
  ...
  return (
    <div className="min-h-full bg-[#f7f4e8] text-[#1b1b18]">
        ...
        <div className="mx-auto flex h-16 max-w-6xl items-center justify-between px-6">
          ...
          <div className="flex items-center gap-2">
            <Button
              variant="outline"
              size="sm"
              className="rounded-full border-black/20 hover:bg-white/60"
            >
              Sign in
            </Button>
            <Button
      ...
      <section className="relative overflow-hidden px-6 pb-16 pt-14 sm:pt-20">
        ...
        <div
          className="pointer-events-none absolute right-6 top-24 h-56 w-56 rounded-full bg-[#1c6a60]/15 blur-3xl animate-hero-glow"
        ...
        <div className="mx-auto grid max-w-6xl gap-10 lg:grid-cols-2">
          <div>
            ...
            <h1
              className="text-4xl font-bold leading-[1.05] tracking-tight sm:text-6xl animate-fade-in-up"
            ...
            <p
              className="mt-5 max-w-xl text-[17px] leading-relaxed text-black/70 animate-fade-in-up"
              style={{ animationDelay: "140ms" }}
            >
              Your AI coworker in IM — deploy in 1 minute, no YAML, no setup. 100% office tools &
              skills built-in, 24/7 next to you.
            </p>
            <div
            ...
            <div
              className="mt-8 text-xs text-black/55 animate-fade-in-up"
      ...
      <section className="px-6 py-14 sm:py-20">
        <div className="mx-auto max-w-[1000px] rounded-[32px] border border-black/20 bg-[radial-gradient(120%_140%_at_90%_0%,#0d2f36_0%,#121212_45%,#0f1013_100%)] px-6 py-10 text-white animate-engine-breathe sm:px-10 sm:py-12">
          <div className="mb-8 text-center">
            <p className="text-[10px] uppercase tracking-[0.2em] text-white/48 animate-fade-in-up">
              The engine
            </p>
            <h2
              className="mt-2 text-[48px] leading-[1] tracking-tight text-white animate-fade-in-up"
              style={{ fontFamily: "var(--font-heading)", animationDelay: "80ms" }}
            >
              Why nexu
            </h2>
            <p
              className="mx-auto mt-3 max-w-3xl text-[13px] leading-relaxed text-white/65 animate-fade-in-up"
              style={{ animationDelay: "140ms" }}
            >
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
            {ENGINE_POINTS.map((item, idx) => (
              ...
              >
                ...
                <div
                  className="text-[43px] leading-none text-white"
                  style={{ fontFamily: "var(--font-heading)" }}
                >
                  {item.stat}
                </div>
                <div className="mt-1 text-[11px] text-white/68">{item.title}</div>
                <p className="mt-3 text-[10px] leading-relaxed text-white/45">{item.desc}</p>
              </article>
            ))}
          </div>
          <p
            className="mx-auto mt-7 max-w-2xl text-center text-[12px] text-white/60 animate-fade-in-up"
            style={{ animationDelay: "240ms" }}
          >
            Works where your team already works — Slack, Discord & Telegram. Always on, always
            learning.
          </p>
        </div>
      </section>
      ...
      <section id="how" className="px-6 py-14 sm:py-20">
        <div className="mx-auto max-w-6xl">
          <div className="mb-10 text-center">
            <h2
              className="text-[58px] leading-[1] tracking-tight text-[#1f1f1d] animate-fade-in-up"
              style={{ fontFamily: "var(--font-heading)" }}
            >
              Get started in <span className="italic text-[#c36a2d]">3 steps.</span>
            </h2>
            <p
              className="mt-3 text-[15px] text-black/58 animate-fade-in-up"
              style={{ animationDelay: "80ms" }}
            >
          ...
          <div className="relative mx-auto max-w-[980px]">
            ...
            {TIMELINE.map((item, idx) => {
              ...
              const card = (
                ...
                >
                  <div className="inline-flex items-center gap-1.5 rounded-full border border-[#e3e4d8] bg-[#eef3ea] px-2.5 py-1">
                    ...
                    <span className="text-[9px] font-semibold uppercase tracking-[0.12em] text-[#5f6f66]">
                      {item.step}
                    </span>
                  </div>
                  <h3
                    className="mt-3 text-[31px] leading-[1] tracking-tight text-[#1e1e1c]"
                    style={{ fontFamily: "var(--font-heading)" }}
                  >
                    {item.title}
                  </h3>
                  ...
                  {item.chips && (
                    <div className="mt-3 flex flex-wrap gap-1.5">
                      {item.chips.map((chip) => (
                        <span
                          key={chip}
                          className="rounded-full border border-[#e1e2d7] bg-[#f0f2ea] px-2 py-0.5 text-[9px] text-[#5d665f] transition-colors duration-200 hover:bg-[#e8ece1]"
                        >
                          {chip}
                        </span>
                      ))}
                  ...
                  {item.metric && (
                    <div className="mt-4 flex items-end gap-2">
                      <div
                        className="text-[54px] leading-none text-[#0e6a56]"
                        style={{ fontFamily: "var(--font-heading)" }}
                      >
                        {item.metric}
                      </div>
              ...
              return (
                <div
                  key={item.step}
                  className="grid min-h-[220px] grid-cols-[1fr_46px_1fr] items-center"
                >
                  <div className="flex justify-end pr-3">{item.side === "left" ? card : null}</div>
                  <div className="flex justify-center">
                    <span
                      className="h-3 w-3 rounded-full border border-[#a7b3ab] bg-[#0c6a56] animate-timeline-dot"
                      style={{ animationDelay: `${idx * 220}ms` }}
                    />
                  </div>
      ...
      <section id="features" className="px-6 py-14 sm:py-20">
        <div className="mx-auto max-w-[980px]">
          <div className="mb-12 text-center">
            <div className="text-[10px] uppercase tracking-[0.2em] text-black/45 animate-fade-in-up">
              How it works
            </div>
            <h2
              className="mt-2 text-[64px] leading-[0.94] tracking-tight text-[#1d1d1b] animate-fade-in-up"
              style={{ fontFamily: "var(--font-heading)", animationDelay: "70ms" }}
            >
              You chat.
              <br />
            ...
            <p
              className="mx-auto mt-4 max-w-[540px] text-[14px] leading-relaxed text-black/62 animate-fade-in-up"
          ...
          <div className="mx-auto grid max-w-[760px] gap-3 md:grid-cols-2">
            <div
              className="rounded-2xl border border-[#e4e4d7] bg-[#f3f3ec] p-5 transition-transform duration-300 hover:-translate-y-1 animate-fade-in-up"
              style={{ animationDelay: "170ms" }}
            >
              <div className="mb-3 text-[10px] text-black/45">Without nexu</div>
              <div
                className="mb-3 text-[52px] leading-none text-[#1f1e1b]"
                style={{ fontFamily: "var(--font-heading)" }}
              >
                35 min
              </div>
            ...
            <div
              className="rounded-2xl border border-[#1f2430] bg-[radial-gradient(130%_130%_at_85%_0%,#0d3642_0%,#14171f_56%,#15151a_100%)] p-5 text-white shadow-[0_8px_24px_rgba(0,0,0,0.22)] transition-transform duration-300 hover:-translate-y-1 animate-fade-in-up animate-feature-glow"
              style={{ animationDelay: "230ms" }}
            >
              <div className="mb-3 text-[10px] text-white/52">With nexu</div>
              <div
                className="mb-2 text-[52px] leading-none text-white"
                style={{ fontFamily: "var(--font-heading)" }}
              >
                0 min
              </div>
              ...
              <ul className="rounded-xl border border-white/10 bg-white/[0.04] p-3 space-y-1.5 text-[10px] text-white/78">
                {[
                  ...
                  >
                    <Check
                      size={12}
                      className="mt-0.5 shrink-0 text-[#7de1a3] animate-energy-pulse"
                      style={{ animationDelay: `${idx * 260}ms` }}
                    />
                    {line}
                  </li>
                ))}
              ...
              <div
                className="mt-2 text-[10px] leading-relaxed text-white/66 animate-fade-in-up"
                style={{ animationDelay: "520ms" }}
              >
                You set it once: "Send Friday status report at 5 PM." nexu runs it every week from
                there.
              </div>
            </div>
          </div>
      ...
      <section id="cases" className="px-6 pt-6 pb-14 sm:pb-20">
        <div className="mx-auto max-w-[1000px] rounded-t-[34px] border border-black/30 bg-[#121318] px-6 pt-8 pb-12 sm:px-10">
          <div className="text-center text-[10px] uppercase tracking-[0.2em] text-white/52 animate-fade-in-up">
            Use cases
          </div>
          <h2
            className="mt-2 text-center text-[56px] leading-[1.02] tracking-tight text-white animate-fade-in-up"
            style={{ fontFamily: "var(--font-heading)", animationDelay: "80ms" }}
          >
          ...
          <div className="mt-10 space-y-10">
            {USE_CASES.map((item, idx) => {
                ...
                >
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="relative">
                      ...
                      <div
                        className="absolute -inset-16 rounded-full border border-white/6 animate-usecase-orbit"
                        style={{ animationDelay: "1.2s" }}
                      />
              ...
              const text = (
                <article
                  className="pt-3 animate-fade-in-up"
                  style={{ animationDelay: `${120 + idx * 120}ms` }}
                >
                  <h3
                    className="text-[42px] leading-[0.98] tracking-tight text-white"
                    style={{ fontFamily: "var(--font-heading)" }}
                  >
                    {item.title}
                  </h3>
                  ...
                  <div className="mt-4 flex flex-wrap gap-2">
                    {item.tags.map((tag) => (
                      <span
                        key={tag}
                        className="rounded-full border border-white/14 bg-white/[0.04] px-2.5 py-1 text-[10px] leading-none font-medium text-white/70 transition-colors duration-200 hover:bg-white/[0.1]"
                      >
                        {tag}
                      </span>
                    ))}
      ...
      <section className="px-6 py-16 sm:py-20">
        <div className="mx-auto max-w-[980px] text-center">
          ...
          <p
            className="mx-auto mt-3 max-w-[600px] text-[13px] leading-relaxed text-black/58 animate-fade-in-up"
            style={{ animationDelay: "90ms" }}
          >
            Build, analyze, automate — right from chat. No integrations to wire up, no plugins to
            install.
          </p>
          ...
          <div className="mt-7 flex flex-wrap justify-center gap-2">
            {INTEGRATION_PILLS.map((tool, idx) => (
              ...
              >
                <span
                  className={`h-1.5 w-1.5 rounded-full ${tool.active ? "bg-[#0f7a61]" : "bg-black/25"}`}
                />
                {tool.name}
              </span>
            ))}
          ...
          <div className="mx-auto mt-8 grid max-w-[900px] gap-3 md:grid-cols-2">
            {[
              ...
              },
              {
                ...
                u: "Sarah Chen",
                t: "2:30 PM",
                q: "@nexu where's the Q1 planning doc?",
                a: "Found it — Q1 2025 Planning, last edited by Priya 2 days ago:\n\n✓ Finalize pricing tiers\n✓ Hire senior backend engineer\n○ Launch beta program — overdue by 5 days\n○ Complete SOC 2 audit — due Feb 28\n○ Ship v2 onboarding flow — due Mar 7",
                r: "👍 3",
              },
              {
                ch: "#sales",
                ...
                u: "James Rivera",
                t: "11:45 AM",
                q: "@nexu status on the Acme deal?",
                a: "From Salesforce:\n\nAccount: Acme Corp · Enterprise\nStage: Negotiation · $85,000 ARR\nClose: Feb 28, 2025\nChampion: VP Eng · Lisa Park\n\nNo follow-up since last call. Draft a check-in email?",
                r: "👍 2",
              },
              {
                ch: "#marketing",
                ...
                u: "Alex Reyes",
                t: "9:20 AM",
                q: "@nexu how did Q4 campaign perform?",
                a: "Q4 Product Launch from HubSpot:\n\n📣 12,400 contacts reached\n📨 34% open rate (↑ 21%)\n📊 8.2% click-through\n🎯 186 MQLs generated\n🏆 Top: Enterprise at 41%\n\n22% better than Q3 overall.",
                r: "🔥 4 · 📈 2",
              },
              {
                ch: "#engineering",
                ...
                u: "Priya Anand",
                t: "3:10 PM",
                q: "@nexu create a bug for login crash on mobile",
                a: 'Created LIN-892 — "Login crash on mobile (iOS + Android)". Bug High, assigned to @marcus, Sprint 13.\n\nFound 3 matching Sentry errors and linked them.',
                r: "⚡ 3 · ✅ 1",
                btns: true,
              },
              {
                ...
                u: "Dana Lee",
                t: "4:05 PM",
                q: "@nexu what are customers complaining about?",
                a: "This week's Intercom conversations:\n\n1. CSV export timeouts · 12 tickets ▲ 3×\n2. SSO setup issues · 8 tickets ▲ new\n3. Billing page errors · 5 tickets — steady\n\nExport spike started after yesterday's deploy.",
                r: "🚨 3 · 👍 2",
              },
            ].map((card, ci) => (
              <div
                key={`${card.ch}-${ci}`}
                className="rounded-2xl border border-[#dedfd2] bg-[#f2f2ee] shadow-[0_1px_2px_rgba(0,0,0,0.06)] text-left overflow-hidden animate-fade-in-up animate-chatcard-breathe"
                style={{ animationDelay: `${180 + ci * 100}ms` }}
              >
                <div className="border-b border-[#e5e5da] px-3 py-1.5 text-[11px] font-semibold text-black/58">
                  {card.ch}
                </div>
                <div className="p-3">
                  <div className="mb-2 text-[11px] text-black/72">
                    <div className="flex items-center gap-1.5">
                      <span
                        className="inline-flex h-5 w-5 items-center justify-center rounded text-[8px] font-semibold"
                        style={{ backgroundColor: card.abg, color: card.ac }}
                      >
                        {card.av}
                      </span>
                  ...
                  <div className="rounded-xl border border-[#e0e1d6] bg-white p-2.5">
                    <div className="mb-1 flex items-center gap-1.5 text-[11px]">
                      <span className="inline-flex h-5 w-5 items-center justify-center rounded bg-[#ff6d5e] text-[8px] font-bold text-white">
                        N
                      </span>
                      <span className="font-semibold text-black/78">nexu</span>
                      <span className="text-[10px] text-black/40">APP · {card.t}</span>
                    </div>
                    <div className="whitespace-pre-line text-[11px] leading-[1.55] text-black/72">
                      {card.a}
                    </div>
                    {card.btns && (
                      <div className="mt-2 flex gap-2">
                        <Button
                          size="sm"
                          className="h-auto rounded-md bg-[#0f6a53] px-2 py-0.5 text-[9px] font-semibold text-white hover:bg-[#0f6a53]/90"
                        >
                          View in Linear
                        </Button>
                        <Button
                          variant="outline"
                          size="sm"
                          className="h-auto rounded-md border-black/12 bg-white px-2 py-0.5 text-[9px] font-semibold text-black/70"
                        >
                          View Sentry
                        </Button>
                      </div>
          ...
          <div
            className="mt-6 text-[10px] uppercase tracking-[0.16em] text-black/42 animate-fade-in-up"
      ...
      <section id="trust" className="px-6 py-14 sm:py-20">
        <div className="mx-auto max-w-[1000px] rounded-[34px] border border-black/25 bg-[radial-gradient(130%_130%_at_85%_0%,#0d3540_0%,#13161e_52%,#111319_100%)] px-7 py-9 text-white sm:px-10 animate-trust-breathe">
          <div className="grid gap-8 lg:grid-cols-[1fr_0.95fr]">
            <div>
              <h3
                className="text-[54px] leading-[0.98] tracking-tight text-white animate-fade-in-up"
                style={{ fontFamily: "var(--font-heading)" }}
              >
                Your data stays yours.
              </h3>
              <p
                className="mt-3 max-w-[460px] text-[13px] leading-relaxed text-white/62 animate-fade-in-up"
                style={{ animationDelay: "80ms" }}
              >
                Enterprise-grade infrastructure with encryption, tenant isolation, and
              ...
              <div className="mt-5 space-y-2.5">
                {TRUST_FEATURES.map((item, idx) => (
                  <div
                    key={item.title}
                    className="rounded-xl border border-white/10 bg-white/[0.03] p-3 animate-fade-in-up transition-transform duration-300 hover:-translate-y-0.5"
            ...
            <div className="rounded-2xl border border-white/12 bg-white/[0.03] p-4 animate-trust-panel-float">
              <div className="mb-3 text-[10px] uppercase tracking-[0.12em] text-white/48">
                Channel access
              </div>
              <div className="space-y-1.5">
                {CHANNEL_ACCESS.map((item, idx) => (
                  <div
                    key={item.name}
                    className="flex items-center justify-between rounded-md border border-white/8 bg-black/15 px-2.5 py-1.5 text-[11px] animate-fade-in-up"
                  ...
                  >
                    ...
                    <span className="inline-flex items-center gap-1 text-white/62">
                      {item.status}
                      <span
                        className={`h-1.5 w-1.5 rounded-full ${item.status === "Active" ? "bg-[#61d4a7] animate-status-dot" : "bg-white/25"}`}
                      />
                    </span>
                  </div>
                ))}
              ...
              <div className="mt-4 rounded-xl border border-white/10 bg-black/20 p-3">
                <div className="mb-2 text-[10px] uppercase tracking-[0.12em] text-white/45">
                  Activity log
                </div>
                <div className="space-y-1.5">
                  {ACTIVITY_LOG.map((line) => (
                    <div key={line} className="text-[10px] leading-relaxed text-white/58">
                      {line}
                    </div>
                  ))}
                </div>
      ...
      <section className="px-6 pb-8 pt-4">
        <div className="mx-auto max-w-[980px] text-center">
          ...
          <h2
            className="mt-2 text-[66px] leading-[0.95] tracking-tight text-[#1d1d1b] animate-fade-in-up"
            style={{ fontFamily: "var(--font-heading)", animationDelay: "80ms" }}
          >
        ...
        <div className="mx-auto max-w-[1000px]">
          <div className="grid items-center gap-9 lg:grid-cols-[0.72fr_1fr]">
            <div className="max-w-[350px] lg:pl-3 animate-fade-in-up">
              <h3
                className="text-[45px] leading-[1.02] tracking-tight text-[#1f1f1d]"
                style={{ fontFamily: "var(--font-heading)" }}
              >
                An AI with its own computer.
              </h3>
              <p
                className="mt-3 text-[14px] leading-[1.8] text-black/62 animate-fade-in-up"
                style={{ animationDelay: "90ms" }}
              >
                nexu isn&apos;t a stateless chatbot. It&apos;s always running on a dedicated machine
                — constantly listening, building context, and picking up where it left off. It
                remembers past conversations, knows what happened last week, and acts without being
                asked twice. No re-explaining. No copy-pasting.
              </p>
            </div>

            <div
              className="w-full max-w-[525px] justify-self-end rounded-[10px] border border-black/35 bg-[#11161d] p-3 text-white shadow-[0_8px_26px_rgba(0,0,0,0.22)] animate-fade-in-up animate-underhood-card"
              style={{ animationDelay: "150ms" }}
            >
              <div
                className="mb-3 flex items-center justify-between rounded-md border border-white/10 bg-black/20 px-3 py-2 text-[11px] animate-fade-in-up"
              ...
              <div className="grid gap-2 sm:grid-cols-2">
                {[
                  ...
                  <div
                    key={item.title}
                    className="rounded-md border border-white/10 bg-black/20 px-3 py-2.5 animate-fade-in-up"
                    style={{ animationDelay: `${260 + idx * 70}ms` }}
                  >
                    <div className="text-[10px] text-white/85">{item.title}</div>
                    <div className="mt-0.5 text-[9px] uppercase tracking-[0.06em] text-white/42">
                      {item.desc}
                    </div>
                  </div>
                ))}
              ...
              <div
                className="mt-2.5 rounded-md border border-white/10 bg-black/20 px-3 py-2 text-[10px] text-white/70 animate-fade-in-up"
              ...
              <div
                className="mt-2.5 flex flex-wrap items-center gap-1.5 border-t border-white/10 pt-2 text-[9px] text-white/40 animate-fade-in-up"
                style={{ animationDelay: "610ms" }}
              >
                <span className="rounded bg-white/5 px-1.5 py-0.5">job: err-repro</span>
                <span className="rounded bg-[#5a2b19] px-1.5 py-0.5 text-[#f5ac76]">
                  priority: high
                </span>
                <span className="rounded bg-[#3b2f1c] px-1.5 py-0.5 text-[#f2be73]">
                  scope: billing
                </span>
          ...
          <div className="mt-10 grid items-center gap-9 lg:grid-cols-[1fr_0.72fr]">
            <div
              className="w-full max-w-[525px] rounded-[10px] border border-black/35 bg-[#11161d] p-3 text-white shadow-[0_8px_26px_rgba(0,0,0,0.22)] animate-fade-in-up animate-underhood-card"
              style={{ animationDelay: "200ms" }}
            >
              <div
                className="mb-2 flex items-center gap-2 text-[10px] text-white/56 animate-fade-in-up"
                style={{ animationDelay: "260ms" }}
              >
                <span className="h-4 w-4 rounded-full bg-[#39c59a]/20 text-center leading-4 text-[#6de2bc]">
                  M
                </span>
                Mike <span className="text-white/35">10:18 PM</span>
              </div>
              <div
                className="mb-2 text-[11px] text-white/84 animate-fade-in-up"
                style={{ animationDelay: "320ms" }}
              >
                @nexu run friday standup
              </div>

              <div
                className="rounded-md border border-white/10 bg-black/20 p-2.5 animate-fade-in-up"
              ...
              >
                <div className="mb-2 flex items-center justify-between text-[10px]">
                  ...
                  <span className="rounded bg-[#0f3d31] px-1.5 py-0.5 text-[9px] text-[#69dbb3]">
                    ACTIVE
                  </span>
                </div>
                <div className="rounded-md border border-white/10 bg-[#161b22] px-2 py-1.5 text-[10px] text-white/82">
              ...
              <div
                className="mt-2 text-[9px] text-white/38 animate-fade-in-up"
                style={{ animationDelay: "460ms" }}
              >
                Completed in 4.2s | 18 actions | next run in 14h 29m
              </div>
            </div>

            <div
              className="max-w-[350px] justify-self-start animate-fade-in-up"
            ...
            >
              ...
              >
                Skills are just plain-English documents that describe a task — no code, no config
                files. Write what you want done in natural language, and nexu follows the
                instructions. Trigger with a phrase or run on a schedule.
              </p>
            </div>
          </div>
          ...
          <div className="mt-10 grid items-center gap-9 lg:grid-cols-[0.72fr_1fr]">
            <div className="max-w-[350px] lg:pl-3 animate-fade-in-up">
              ...
              <p
                ...
                style={{ animationDelay: "90ms" }}
              >
                Every team gets a dedicated server — dedicated resources, isolated runtime,
                encrypted secrets vault. Not shared infrastructure. Your data never leaves your
                instance.
              </p>
            </div>
            ...
            >
              ...
              <div
                className="mt-2.5 rounded-md border border-white/10 bg-black/20 px-3 py-2 text-[10px] animate-fade-in-up"
                style={{ animationDelay: "540ms" }}
              >
                <div className="mb-1 text-[9px] uppercase tracking-[0.08em] text-white/42">
                  Usage this month
                </div>
                <div
                ...
                <div className="mt-1.5 space-y-1 text-[9px] text-white/58">
                  <div className="flex justify-between">
                    <span>Sprint reports generated</span>
                    <span>312 cr</span>
                  </div>
                  <div className="flex justify-between">
                    <span>PRs triaged and summarized</span>
                    <span>847 cr</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Emails drafted and sent</span>
                    <span>156 cr</span>
                  </div>
                  <div className="flex justify-between">
              ...
              <div
                className="mt-2.5 flex items-center justify-between rounded-md border border-white/10 bg-black/20 px-3 py-2 text-[10px] animate-fade-in-up"
                style={{ animationDelay: "610ms" }}
              >
                <div>
                  <div className="text-white/88">nexu</div>
                  <div className="text-[9px] text-white/42">
                    24 members · $49/mo · <span className="text-[#69dbb3]">$0 per seat</span>
                  </div>
                </div>
                <div className="text-right">
                  <div className="text-white/50 line-through">Per-seat tools</div>
                  <div className="text-[9px] text-white/42">
                    24 members · $1,200/mo · $50 per seat
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="px-6 pb-7 pt-10 sm:pt-14">
        <div
          id="customers"
          className="mx-auto max-w-[1040px] rounded-[34px] bg-[#111319] pb-8 pt-9 text-white animate-social-breathe"
        >
          <div className="mb-8 text-center">
            <h2
              className="text-[66px] leading-[0.9] tracking-tight text-white animate-fade-in-up"
              style={{ fontFamily: "var(--font-heading)" }}
            >
              Teams that stopped
              <br />
              <span className="bg-gradient-to-r from-[#f2fff7] via-[#7dc8bf] to-[#f2fff7] bg-clip-text text-transparent">
                being the glue
              </span>
            </h2>
          </div>
          ...
          <div className="overflow-x-auto no-scrollbar px-4">
            <div className="flex min-w-max gap-3 animate-social-strip">
              {testimonialStrip.map((item, idx) => (
                <article
                  key={`${item.name}-${idx}`}
                  className="w-[258px] shrink-0 rounded-xl bg-[#f7f4e8] p-4 text-black transition-transform duration-300 hover:-translate-y-1"
                >
                  <p className="line-clamp-4 text-[11px] leading-relaxed text-black/72">
                    {item.quote}
                  </p>
        ...
        <div className="mx-auto grid max-w-[1040px] gap-4 md:grid-cols-2">
          {VALUE_CALLOUTS.map((item, idx) => (
            <article
              ...
              style={{ animationDelay: `${idx * 220}ms` }}
            >
              <span className="absolute right-4 top-3 text-[12px] text-[#8fe6dd] animate-energy-pulse">
                ↗
              </span>
              <h3
                className="text-[42px] leading-[0.98] tracking-tight text-[#ecfff9] animate-fade-in-up"
                style={{
                  fontFamily: "var(--font-heading)",
                  animationDelay: `${120 + idx * 220}ms`,
                }}
              >
                {item.metric}
              </h3>
              <p
                className="mt-2 max-w-[420px] text-[13px] leading-relaxed text-[#bde8df] animate-fade-in-up"
                style={{ animationDelay: `${180 + idx * 220}ms` }}
              >
                {item.desc}
              </p>
              <div
                className="mt-4 flex items-center gap-2 animate-fade-in-up"
                style={{ animationDelay: `${240 + idx * 220}ms` }}
              >
                <div className="h-6 w-6 rounded-full bg-gradient-to-br from-[#d2c3a7] to-[#8b7c68]" />
                <div>
      ...
      <section className="px-6 pb-6 pt-2">
        <div className="mx-auto max-w-[980px] text-center">
          <h2
            className="text-[62px] leading-[0.95] tracking-tight text-[#1d1d1a] animate-fade-in-up"
            style={{ fontFamily: "var(--font-heading)" }}
          >
            Pay for actions, not headcount
          </h2>
          <p
            className="mx-auto mt-3 max-w-[520px] text-[13px] leading-relaxed text-black/58 animate-fade-in-up"
            style={{ animationDelay: "80ms" }}
          >
      ...
      <section id="pricing" className="px-6 py-14 sm:py-20">
        <div className="mx-auto max-w-[1040px] rounded-[34px] bg-[#111319] px-7 pb-10 pt-11 text-white sm:px-10 animate-pricing-breathe">
          <div className="mb-9 text-center">
            <h2
              className="text-[62px] leading-[0.95] tracking-tight text-white animate-fade-in-up"
              style={{ fontFamily: "var(--font-heading)" }}
            >
              Pricing
            </h2>
            <p
              className="mx-auto mt-2 max-w-[440px] text-[13px] leading-relaxed text-white/58 animate-fade-in-up"
              style={{ animationDelay: "90ms" }}
            >
              Start for free. Upgrade to get the capacity that exactly matches your team&apos;s
              needs.
            </p>
          </div>
          ...
          <div className="grid gap-3 lg:grid-cols-3">
            {PRICING.map((p, idx) => (
              ...
              >
                {p.highlight && (
                  <span className="pointer-events-none absolute inset-y-0 -left-1/2 w-1/2 -skew-x-12 bg-gradient-to-r from-transparent via-white/40 to-transparent animate-pricing-sheen" />
                )}
                <div
                  className={`text-[10px] font-semibold uppercase tracking-[0.12em] ${p.highlight ? "text-black/50" : "text-white/48"}`}
                >
                  {p.plan}
                </div>
                <div className="mt-2 flex items-end gap-1.5">
                  <div
                    className={`text-[48px] leading-none tracking-tight ${p.highlight ? "text-black" : "text-white"}`}
                    style={{ fontFamily: "var(--font-heading)" }}
                  >
                    {p.price}
                  </div>
                  {p.price !== "Custom" && (
                    <div
                      className={`pb-1 text-[11px] ${p.highlight ? "text-black/55" : "text-white/55"}`}
                    >
                      /month
                    </div>
                  )}
                ...
                <p
                  className={`mt-1 text-[11px] leading-relaxed ${p.highlight ? "text-black/58" : "text-white/45"}`}
                >
                  {p.note}
                </p>
                ...
                {p.highlight && (
                  <Button
                    variant="outline"
                    className="mt-3 w-full justify-between rounded-md border-black/10 bg-[#ece7d7] px-2.5 py-1.5 text-[11px] text-black/70 hover:bg-[#e5dfcf]"
                  >
                    <span>{p.credits}</span>
                    <span>⌄</span>
                  </Button>
                ...
                <ul className="space-y-1.5">
                  {p.items.map((item, itemIdx) => (
                    <li
                      key={item}
                      className={`flex gap-2 text-[11px] leading-relaxed animate-fade-in-up ${p.highlight ? "text-black/72" : "text-white/68"}`}
                      style={{ animationDelay: `${240 + idx * 110 + itemIdx * 45}ms` }}
                    >
      ...
      <section className="px-4 pb-8 pt-6 sm:px-6 sm:pb-10">
        <div className="relative mx-auto max-w-[1040px] overflow-hidden rounded-[26px] border border-black/15 bg-[radial-gradient(85%_90%_at_50%_52%,#04675f_0%,#023636_38%,#071017_78%,#0a0d13_100%)] px-6 py-14 text-center text-white sm:px-10 animate-final-cta-breathe">
          <div
            className="pointer-events-none absolute inset-0 opacity-35 animate-final-stars-drift"
            style={{
              backgroundImage: "radial-gradient(#d8f5f0 0.8px, transparent 0.8px)",
              backgroundSize: "18px 18px",
            }}
          />
          <div className="relative">
            <h2
              className="text-[84px] leading-[0.92] tracking-tight text-white animate-fade-in-up"
              style={{ fontFamily: "var(--font-heading)" }}
            >
              The simplest OpenClaw. Always on, always learning.
            </h2>
            <p
              className="mx-auto mt-3 max-w-[470px] text-[13px] leading-relaxed text-white/66 animate-fade-in-up"
              style={{ animationDelay: "90ms" }}
            >
            ...
            <div
              className="mt-3 text-[10px] text-white/38 animate-fade-in-up"
              style={{ animationDelay: "260ms" }}
            >
      ...
      <footer className="bg-[#f7f4e8] px-6 py-8">
        <div className="text-center text-xs text-black/45">Always on, always learning.</div>
      </footer>
    </div>
  );
}
