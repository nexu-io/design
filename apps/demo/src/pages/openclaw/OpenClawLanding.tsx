...
function GDriveIcon({ size = 20 }: { size?: number }) {
  return (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="#0F9D58">
...
const SLACK_EXPERIENCE_GROUP_URL = 'https://join.slack.com/t/nexu-ixl1131/shared_invite/zt-3ridrx1sn-Cbu6IFNcdjKq4c1p27ZGUw';
        ...
        <div className="absolute left-1/2 -translate-x-1/2 top-full mt-3 w-64 rounded-lg border border-border/60 bg-surface-0 shadow-[var(--shadow-dropdown)] shadow-black/10 overflow-hidden animate-in fade-in zoom-in-95 duration-150">
          <div className="p-1.5">
            ...
            >
              ...
              <div>
                <div className="text-[13px] font-semibold text-text-primary group-hover:text-accent transition-colors">All Skills</div>
            ...
            {tags.map(([id, label]) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="text-[12px] font-medium text-text-secondary group-hover:text-text-primary transition-colors">{label}</span>
                </Link>
              );
            })}
          </div>
    ...
    <div className="min-h-full bg-surface-0 relative">
      ...
      <section className="relative z-10">
        ...
        <div className="relative px-6 pt-16 pb-12 sm:pt-24 sm:pb-20 mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-lg leading-relaxed text-text-tertiary">
            ...
            <br className="hidden sm:inline" />
            100% office tools & skills built-in, 24/7 next to you in Slack, Discord & Telegram. Always on, always learning.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center items-stretch sm:items-center mx-auto mb-6 max-w-md">
            ...
            <Button variant="outline" size="lg" asChild>
              <a
                href={SLACK_EXPERIENCE_GROUP_URL}
                target="_blank"
      ...
      <section className="px-6 py-12 sm:py-16 mx-auto max-w-3xl text-center">
        ...
        <p className="text-sm text-text-tertiary leading-relaxed mb-10">
          One AI in Slack, integrated with Google Workspace—Gmail, Calendar, Drive, Docs, Sheets, Meet and more.
        </p>
      ...
      <section id="features" className="px-6 py-12 sm:py-24 mx-auto max-w-4xl">
        <div className="mb-14 text-center">
          ...
          <p className="mx-auto mt-3 max-w-lg text-sm leading-relaxed text-text-tertiary">
            The simplest OpenClaw — ready in under a minute, with persistent memory and every tool your team needs. Always on in Slack, Discord & Telegram.
          </p>
        </div>
          ...
          <table className="w-full text-left text-sm">
            <thead>
              <tr className="border-b border-border">
                ...
                <th className="px-5 py-4 font-semibold text-text-secondary">OpenClaw (Self-Hosted)</th>
              </tr>
            </thead>
            <tbody className="text-text-secondary">
              <tr className="border-b border-border">
                ...
                <td className="px-5 py-3"><span className="inline-flex items-center gap-1.5"><X size={14} className="text-[var(--color-danger)] shrink-0" /> {'>'}24 h (YAML / env / keys)</span></td>
              </tr>
              <tr className="border-b border-border">
                <td className="px-5 py-3 font-medium text-text-primary">Data & memory</td>
                <td className="px-5 py-3"><span className="inline-flex items-center gap-1.5"><Check size={14} className="text-[var(--color-success)] shrink-0" /> Persistent — zero data loss, learns your team</span></td>
                <td className="px-5 py-3"><span className="inline-flex items-center gap-1.5"><X size={14} className="text-[var(--color-danger)] shrink-0" /> Session stateless, no persistent learning</span></td>
              </tr>
              <tr className="border-b border-border">
                <td className="px-5 py-3 font-medium text-text-primary">Tools & skills</td>
                <td className="px-5 py-3"><span className="inline-flex items-center gap-1.5"><Check size={14} className="text-[var(--color-success)] shrink-0" /> 1,000+ built in, out of the box</span></td>
                <td className="px-5 py-3"><span className="inline-flex items-center gap-1.5"><X size={14} className="text-[var(--color-danger)] shrink-0" /> You build or plug in integrations</span></td>
              </tr>
              <tr className="border-b border-border">
                <td className="px-5 py-3 font-medium text-text-primary">IM platforms</td>
                <td className="px-5 py-3"><span className="inline-flex items-center gap-1.5"><Check size={14} className="text-[var(--color-success)] shrink-0" /> Slack, Discord, Telegram</span></td>
                <td className="px-5 py-3"><span className="inline-flex items-center gap-1.5"><X size={14} className="text-[var(--color-danger)] shrink-0" /> You build integrations</span></td>
              </tr>
              <tr className="border-b border-border">
                <td className="px-5 py-3 font-medium text-text-primary">Hosting</td>
                <td className="px-5 py-3"><span className="inline-flex items-center gap-1.5"><Check size={14} className="text-[var(--color-success)] shrink-0" /> Fully hosted, 24/7</span></td>
                <td className="px-5 py-3"><span className="inline-flex items-center gap-1.5"><X size={14} className="text-[var(--color-danger)] shrink-0" /> Self-hosted, uptime depends on you</span></td>
              </tr>
              <tr className="border-b border-border">
                <td className="px-5 py-3 font-medium text-text-primary">Updates</td>
                <td className="px-5 py-3"><span className="inline-flex items-center gap-1.5"><Check size={14} className="text-[var(--color-success)] shrink-0" /> Automatic</span></td>
                <td className="px-5 py-3"><span className="inline-flex items-center gap-1.5"><X size={14} className="text-[var(--color-danger)] shrink-0" /> Manual pull / upgrade</span></td>
              </tr>
              <tr className="border-b border-border">
                <td className="px-5 py-3 font-medium text-text-primary">Team context</td>
                <td className="px-5 py-3"><span className="inline-flex items-center gap-1.5"><Check size={14} className="text-[var(--color-success)] shrink-0" /> Multi-user, cross-channel awareness</span></td>
                <td className="px-5 py-3"><span className="inline-flex items-center gap-1.5"><X size={14} className="text-[var(--color-danger)] shrink-0" /> Mostly single-session</span></td>
              </tr>
            </tbody>
          </table>
        </div>
        <p className="mt-4 text-center text-[13px] text-text-muted">
          The simplest OpenClaw. Ready in under a minute, with persistent memory and 1,000+ tools — always on in Slack, Discord & Telegram.
        </p>
      </section>
      ...
      <section className="px-6 py-12 sm:py-24 mx-auto max-w-5xl">
        <div className="mb-14 text-center">
          ...
          <p className="mx-auto mt-2 max-w-lg text-sm leading-relaxed text-text-tertiary">
            Startup/remote teams · E-commerce · Creators & multi-group users. Slack, Discord, Telegram.
          </p>
        </div>
          ...
          {[
            {
              ...
              result: 'Turn hundreds of messages into one structured daily: decisions, progress, todos, risks. Everyone catches up in 30 seconds.',
              time: 'Daily',
            },
            {
              icon: BarChart3,
              ...
              result: 'Turn hundreds of support messages into a daily customer feedback report. See what\'s working and what\'s not in 30 seconds.',
              time: 'Daily',
            },
            {
              icon: PenTool,
              ...
              result: 'Auto-detect great quotes and turn them into shareable brand cards. Team thinking becomes external content.',
              time: 'Real-time',
            },
            {
              icon: MessageSquare,
              ...
              result: 'Auto-answer FAQs in the group; escalate complex questions to humans. No more repeating "how to use" or "when it ships."',
              time: '24/7',
            },
            {
              icon: Users,
              ...
              result: 'One digest across all your groups, ranked by importance. See every group\'s highlights in 5 minutes—no scrolling.',
              time: 'On demand',
            },
            {
              icon: Workflow,
              ...
              result: 'Filter a week of group chat into highlights and get a Newsletter draft. 2 hours of manual work → 5 minutes.',
              time: 'Weekly',
            },
          ].map((c) => (
            <div
      ...
      <footer className="border-t border-border">
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 px-6 py-8 mx-auto max-w-5xl">
          <div className="flex items-center gap-2">
            <img src="/brand/nexu logo-black4.svg" alt="nexu" className="h-5 w-auto object-contain" />
