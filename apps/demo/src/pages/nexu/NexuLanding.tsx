...
function FeatureCard({
  ...
  return (
    <div className="card p-6 group">
      ...
      <div className="mb-2 text-[14px] font-semibold text-text-primary">{title}</div>
          ...
          {["运营助手", "研发助手", "内容助手", "创始人分身"].map((name, i) => (
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                ...
                <div className="text-[9px] text-text-muted">{i % 3 === 0 ? "执行中" : "空闲"}</div>
              </div>
            </div>
          ))}
        </div>
    ...
    <div className="min-h-full bg-surface-0">
      ...
      <section id="features" className="mx-auto max-w-4xl px-6 py-24">
        <div className="mb-14 text-center">
          ...
          <p className="mx-auto mt-3 max-w-lg text-sm leading-relaxed text-text-tertiary">
            预设运营 / 研发 / 内容 /
            创始人等角色，每个分身独立技能与知识库，关键节点可审批、可纠偏。
          </p>
        </div>
      ...
      <section id="how" className="mx-auto max-w-4xl px-6 py-24">
        <div className="mb-14 text-center">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-text-primary">3 步，开始用分身</h2>
          <p className="mx-auto mt-3 max-w-lg text-sm leading-relaxed text-text-tertiary">
        ...
        <div className="grid grid-cols-3 gap-12">
          {[
            ...
            <div key={s.step} className="relative">
              ...
              <h3 className="mb-2 text-[14px] font-semibold text-text-primary">{s.title}</h3>
      ...
      <section id="faq" className="mx-auto max-w-2xl px-6 py-24">
        <div className="mb-14 text-center">
          ...
          <h2 className="text-2xl font-bold tracking-tight text-text-primary">你可能想知道</h2>
        </div>
        <div>
          <FAQItem
      ...
      <footer className="border-t border-border">
        <div className="mx-auto flex max-w-5xl items-center justify-between px-6 py-8">
          ...
          <div className="flex gap-6 text-xs text-text-muted">
            ...
            <a href="/docs/getting-started" className="transition-colors hover:text-text-secondary">
              集成指南
            </a>
          </div>
        </div>
