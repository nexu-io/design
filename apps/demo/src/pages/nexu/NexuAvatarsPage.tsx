  ...
  return (
    <div className="h-full overflow-y-auto">
      <div className="mx-auto max-w-4xl px-6 py-8 space-y-8">
        <div>
          <h1 className="text-xl font-bold tracking-tight text-text-primary">分身与角色</h1>
          ...
          {PRESET_ROLES.map((role) => {
            ...
            return (
              <InteractiveRow
                ...
                className="group flex flex-col p-5 hover:border-accent/40"
              >
                <div className="flex items-start justify-between gap-3">
                  <InteractiveRowLeading className="flex h-12 w-12 items-center justify-center rounded-[12px] bg-white border border-border text-accent">
                    <Users size={22} />
                  </InteractiveRowLeading>
                  <Badge
                    variant={
                ...
                <InteractiveRowContent className="mt-3">
                  <h3 className="text-[14px] font-semibold text-text-primary">{role.name}</h3>
                ...
                <InteractiveRowTrailing className="mt-3 flex items-center gap-1 self-start text-[11px] text-accent opacity-0 transition-opacity group-hover:opacity-100">
                  查看详情
        ...
        <div className="rounded-xl border border-dashed border-border bg-surface-2/50 p-6 text-center">
          ...
          <p className="mt-2 text-[13px] font-medium text-text-secondary">添加自定义分身</p>
