...
const PRESET_AVATARS = [
  ...
  { id: 'dev', name: '研发助手', desc: 'Bug 跟进、代码 Review、文档', status: 'busy', roleColor: 'role-programmer' },
  { id: 'content', name: '内容助手', desc: '文案、排版、多平台发布', status: 'idle', roleColor: 'role-designer' },
  { id: 'founder', name: '创始人分身', desc: '战略摘要、投资人同步、决策备忘', status: 'waiting', roleColor: 'role-founder' },
]
        ...
        <section className='rounded-2xl border-2 border-accent/20 bg-accent-subtle p-6 shadow-[var(--shadow-refine)]'>
          ...
          >
            <div className='flex items-end gap-3 px-4 pt-4 pb-3'>
              ...
              />
              <Button type='submit' className='shrink-0 rounded-xl px-4 py-2.5 font-semibold shadow-sm'>
                <Sparkles size={16} />
                下达
              </Button>
            </div>
