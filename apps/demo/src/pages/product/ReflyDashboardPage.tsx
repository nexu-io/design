...
import { ArrowUp, Eye, MoreVertical, Plus } from "lucide-react";
    ...
    <div className="h-full overflow-y-auto bg-white">
      <div className="mx-auto max-w-[960px] px-8 py-10 space-y-10">
        ...
        <section className="flex flex-col items-center gap-6 pt-4">
          ...
          <form onSubmit={handleSubmit} className="relative w-full max-w-[640px]">
            <div className="rounded-[16px] border border-[var(--color-brand-primary)]/40 bg-white p-4 pr-14 shadow-[var(--shadow-m)] transition-all duration-200 focus-within:border-[var(--color-brand-primary)] focus-within:shadow-[var(--shadow-focus)]">
              <textarea
                value={query}
        ...
        <section className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <Button type="button" variant="ghost" size="inline" className="text-[13px]">
              more
            </Button>
          </div>
            ...
            {MY_WORKFLOWS.map((wf) => (
              ...
              >
                ...
                <div className="mt-3 flex items-center justify-between">
                  <span className="text-[12px] text-[var(--color-text-muted)]">{wf.date}</span>
              ...
              >
                ...
                <div className="relative h-[140px] overflow-hidden">
                  <div
                    ...
                    style={{
                      background: `linear-gradient(${135 + (item.image - 1) * 30}deg, ${
                        ["#2d1b69", "#1a3a4a", "#4a1a3a", "#1a2a4a"][item.image - 1]
                      } 0%, ${["#8b5cf6", "#3db9ce", "#f472b6", "#60a5fa"][item.image - 1]} 50%, ${
                        ["#c084fc", "#7dcedc", "#fb7185", "#93c5fd"][item.image - 1]
                      } 100%)`,
                    }}
                  />
