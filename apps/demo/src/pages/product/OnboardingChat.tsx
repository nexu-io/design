        ...
        {shown.map((item) => (
          ...
          >
            ...
            {item.status === "available" && (
              <button
                type="button"
                className="mt-1.5 w-full flex items-center justify-center gap-1 px-2 py-1 bg-accent/10 text-accent rounded-md text-[10px] font-medium hover:bg-accent/15 transition-colors"
              >
                <Link2 size={9} />
                授权连接
              </button>
