        ...
        <div className="grid grid-cols-4 gap-4">
          {[
            ...
            <div key={t.name} className="bg-surface-2 rounded-lg p-4 border border-border">
              <div className="text-lg font-semibold mb-1" style={{ color: t.value }}>
                Aa
              </div>
              <div className="text-xs font-medium" style={{ color: t.value }}>
                {t.name}
              </div>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-4 gap-4">
          ...
          <div className="rounded-lg overflow-hidden border border-border">
            <div
              ...
              style={{ backgroundColor: "rgba(192,138,37,0.10)" }}
            />
            <div className="p-3 bg-surface-2">
          ...
          <div className="rounded-lg overflow-hidden border border-border">
            <div
              className="h-16 border-b border-border"
              style={{ backgroundColor: "rgba(192,138,37,0.20)" }}
            />
            <div className="p-3 bg-surface-2">
        ...
        <div className="mt-6 flex items-center gap-8">
          <div className="text-center">
            <div className="w-16 h-16 rounded-full bg-surface-3 animate-clone-breath flex items-center justify-center text-2xl mx-auto">
              😊
            </div>
          ...
          <div className="text-center">
            <div className="relative">
              <div className="w-16 h-16 rounded-full bg-surface-3 flex items-center justify-center text-2xl mx-auto">
                😊
              </div>
          ...
          <div className="flex-1 text-xs text-text-tertiary leading-relaxed">
            Clone 色只用于分身"活着"的信号 — 呼吸动效、在线指示、新技能学会、里程碑庆祝。
            <br />
            按钮、边框等通用 UI 元素使用 Accent（暖白）。
            <br />
            ...
            <div key={s.name}>
              <div className="flex gap-2 mb-2">
                ...
                <div
                  ...
                  style={{ backgroundColor: s.subtle }}
                />
              </div>
      ...
      <section className="mb-12">
        ...
        <div className="mt-4 bg-surface-2 rounded-lg p-4 border border-border">
          ...
          <div className="w-full h-2 bg-surface-4 rounded-full overflow-hidden">
            <div
              className="h-full rounded-full bg-gradient-to-r from-energy-full via-energy-medium to-energy-full"
              style={{ width: "64%" }}
            />
          </div>
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-5 gap-3">
          {[
            ...
            <div
              key={r.role}
              className="bg-surface-2 border border-border rounded-lg p-4 text-center"
            >
              <div
                className="w-12 h-12 rounded-full mx-auto mb-3 flex items-center justify-center text-lg"
                style={{ backgroundColor: `${r.color}20`, border: `2px solid ${r.color}` }}
              >
